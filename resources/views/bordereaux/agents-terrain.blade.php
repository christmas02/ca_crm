        ...
        <div class="card-body">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('bordereaux.agents-terrain.export', ['format' => 'pdf', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-red-600 hover:bg-red-700">
                    ...
                    <a href="{{ route('bordereaux.agents-terrain.export', ['format' => 'excel', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-green-600 hover:bg-green-700">
