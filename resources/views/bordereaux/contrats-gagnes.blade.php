<x-app-layout>
    <x-slot name="header">Bordereau Contrats Gagnés</x-slot>
    ...
    <div class="mb-6 flex gap-2">
        ...
        <div class="badge bg-green-100 text-green-700">Contrats Gagnés</div>
    </div>
    ...
    <div class="card mb-6">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('bordereaux.contrats-gagnes') }}" class="flex gap-4 items-end flex-wrap">
                <div>
                ...
                <a href="{{ route('bordereaux.contrats-gagnes') }}" class="btn-secondary text-sm">
    ...
    <div class="flex gap-3 mb-6">
        <a href="{{ route('bordereaux.contrats-gagnes.export', ['format' => 'pdf', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-red-600 hover:bg-red-700">
        ...
        <a href="{{ route('bordereaux.contrats-gagnes.export', ['format' => 'excel', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-green-600 hover:bg-green-700">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            Exporter en Excel
        </a>
    </div>

    {{-- Tableau récapitulatif par conseiller --}}
    <div class="card">
        <div class="card-body">
            ...
            @else
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b-2 border-gray-300 bg-gray-50">
                                <th class="text-left py-3 px-3 font-semibold text-gray-700">Agent Conseil</th>
                                ...
                                <th class="text-center py-3 px-3 font-semibold text-gray-700">Détail</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($donnees as $row)
                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                    <td class="py-3 px-3 text-gray-900 font-semibold">{{ $row['nom'] }}</td>
                ...
                <div class="mt-4 pt-4 border-t-2 border-gray-300">
                    <div class="grid grid-cols-11 gap-3 text-sm font-semibold text-gray-900">
