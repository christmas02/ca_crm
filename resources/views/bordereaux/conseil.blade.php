<x-app-layout>
    ...
    <div class="flex gap-3 mb-6">
        <a href="{{ route('bordereaux.conseil.export', ['format' => 'pdf', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-red-600 hover:bg-red-700">
        ...
        <a href="{{ route('bordereaux.conseil.export', ['format' => 'excel', 'date_debut' => $dateDebut->format('Y-m-d'), 'date_fin' => $dateFin->format('Y-m-d')]) }}" class="btn-primary bg-green-600 hover:bg-green-700">
