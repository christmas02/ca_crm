<x-app-layout>
    ...
    <div class="flex gap-3 mb-6">
        <a href="{{ route('opportunities.renewals.export', ['format' => 'pdf', 'search' => request('search'), 'status_id' => request('status_id')]) }}" class="btn-primary bg-red-600 hover:bg-red-700">
        ...
        <a href="{{ route('opportunities.renewals.export', ['format' => 'excel', 'search' => request('search'), 'status_id' => request('status_id')]) }}" class="btn-primary bg-green-600 hover:bg-green-700">
