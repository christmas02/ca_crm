<x-app-layout>
    ...
    {{-- Boutons d'export (Admin seulement) --}}
    @if(auth()->user()->isAdmin())
    <div class="flex gap-3 mb-6">
        <a href="{{ route('opportunities.export', ['format' => 'pdf', 'search' => request('search'), 'status_id' => request('status_id'), 'date_start' => request('date_start'), 'date_end' => request('date_end')]) }}" class="btn-primary bg-red-600 hover:bg-red-700">
        ...
        <a href="{{ route('opportunities.export', ['format' => 'excel', 'search' => request('search'), 'status_id' => request('status_id'), 'date_start' => request('date_start'), 'date_end' => request('date_end')]) }}" class="btn-primary bg-green-600 hover:bg-green-700">
