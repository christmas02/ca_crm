<x-app-layout>
    <x-slot name="header">Ajouter un partenaire d'assurance</x-slot>
    ...
    <div class="max-w-2xl">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('insurance-partners.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pb-6 border-b border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="telephone" name="telephone" value="{{ old('telephone') }}" class="form-input">
                        ...
                        <div class="pb-6 border-b border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="commission_rate" name="commission_rate" value="{{ old('commission_rate', 0) }}" step="0.01" min="0" max="100" required class="form-input">
                        ...
                        <div>
                            <label class="flex items-center gap-3">
                                ...
                                <input type="checkbox" name="active" value="1" {{ old('active', true) ? 'checked' : '' }} class="w-4 h-4 text-primary-600 rounded">
