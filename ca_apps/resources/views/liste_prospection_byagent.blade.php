                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospectioncreated as $listeprospectioncreated_el)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospectioncreated_el['plaque_immatriculation'] ?? 'Non défini'}}</td>
                                                ...
                                                <td>{{$listeprospectioncreated_el['observation']}}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="/enregister_note_propection/{{$listeprospectioncreated_el['id']}}">Commenter</a>
                                                </td>
