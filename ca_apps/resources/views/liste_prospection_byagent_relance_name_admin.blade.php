                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Recherche Relance en cours , critère [Téléphone ]: {{$listeprospection[0]['telephone']}} </h3></td>
                                            </tr>
                                            <tr>
                                          ...
                                          @if (!empty($listeprospection_element['commentaires']));
                                           ...
                                           @if ($listeprospection_element['commentaires'][0]['resultat'] != 'perdu' || $listeprospection_element['commentaires'][0]['resultat'] != 'horscible')
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['plaque_immatriculation'] ??'Non défini'}}</td>
                                                <td>
                                                    <div class="form-check">
