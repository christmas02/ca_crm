            ...
            <div class="row">
                <div class="col-xxl-6" style="margin:auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted" style="font-weight: bold;font-size: 20px;background: #e1e1e1;">
                                NOM : <span style="color: black !important;"> {{$findOpportunity['nom']}}</span> <br> PRENOMS :  <span style="color: black !important;">{{$findOpportunity['prenoms']}}</span><br> TELEPHONE : <span style="color: black !important;">{{$findOpportunity['telephone']}}</span>
                            </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control numberonly" placeholder="1 mois" id="firstNameinput" name="periodesousc">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstNameinput" class="form-label">Prime Net</label>
                                                <input type="text" class="form-control numberonly" placeholder="Montant" id="firstNameinput" name="primenet">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstNameinput" class="form-label">Prime TTC</label>
                                                <input type="text" class="form-control numberonly" placeholder="Montant" id="firstNameinput" name="primettc">
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6">
                                            <div>
                ...
                <!--  Large modal example -->
                            ...
                            <div id="basicdatamodal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div id="formtoupdate" class="card-body formtoupdate" >
                                                            <div class="live-preview">
                                                                <div class="row gy-4">
                                                                    <div class=" col-md-6">
                                                                        <div>
                                                                            <label for="basiInput" class="form-label">Nom</label>
                                                                            <input type="text" class="form-control" id="basiInput" name="edit_name" value="{{$listeoppeff['nom']}}" >
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class=" col-md-6">
                                                                        <div>
                                                                            ...
                                                                            <input type="text" class="form-control" id="labelInput" name="edit_prenoms" value="{{$listeoppeff['prenoms']}}" >
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class=" col-md-6">
                                                                        <div>
                                                                            <label for="exampleInputdate" class="form-label"> Echéance</label>
                                                                            <input type="date" name="edit_dateecheance" class="form-control" id="exampleInputdate" value="{{\Carbon\Carbon::parse($listeoppeff['echeance'])->format('Y-m-d')}}" >
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class=" col-md-6">
                                                                        <label for="firstNameinput" class="form-label">Téléphone</label>
                                                                        <input type="text" name="edit_tel" class="form-control" placeholder="Entrer votre telephone" id="firstNameinput" value="{{$listeoppeff['telephone']}}" >
                                                                    </div>

                                                                    <div class=" col-md-6">
                                                                        <label for="firstNameinput" class="form-label">Téléphone 2</label>
                                                                        <input type="text" name="edit_tel2" class="form-control" placeholder="Entrer votre telephone" id="firstNameinput" value="{{$listeoppeff['telephone2']}}" >
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class=" col-md-6">
                                                                        <div>
                                                                            <label for="readonlyInput" class="form-label">Lieu Prospection</label>
                                                                            <input type="text" name="edit_lieuprospection" class="form-control" id="readonlyInput" value="{{$listeoppeff['lieuprospection']}}" >
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                    <div class=" col-md-6">
                                                                        <div>
                                                                            <label for="exampleFormControlTextarea5" class="form-label">Observation</label>
                                                                            <textarea name="edit_observation" class="form-control" id="exampleFormControlTextarea5" rows="3" >{{$listeoppeff['observation']}}</textarea>
                                                                        </div>
                                                                    </div>

                                                                    <input type="hidden"  name="selectedid" value="{{$listeoppeff['id']}}">
                                                                    <!--end col-->
                                                                </div>
                                                                <!--end row-->
                                                            </div>
                                            ...
                                            <div class="row formtoupdate">
                                                <div class="col-xxl-6">
                                                    <div class="card card-height-100 ">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mx-auto mb-3" style="max-width: 350px">
                                                                @if ($listeoppeff['url_attestationassurance']!='')
                                                                {{-- expr --}}
                                                                <img src="{{$listeoppeff['url_attestationassurance']}}" style="width: 350px;height: 200px; margin: 0 auto;display: block;" alt="">
                                                                @else
                                                                <img src="/assets/images/No-Image-Placeholder.png" style="width: 350px;height: 200px; margin: 0 auto;display: block;" alt="">
                                                                @endif
                                                                <!-- end card div elem -->
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-wrapper mb-3">
                                                                @if ($listeoppeff['urlcarte_grise']!='')
                                                                {{-- expr --}}
                                                                <img src="{{$listeoppeff['urlcarte_grise']}}" style="width: 350px;height: 200px; margin: 0 auto;display: block;" alt="">
                                                                @else
                                                                <img src="/assets/images/No-Image-Placeholder.png" style="width: 350px;height: 200px; margin: 0 auto;display: block;" alt="">
                                                                @endif
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                            ...
                                                            <div class="live-preview">
                                                                <div class="table-responsive">
                                                                    <table class="table table-striped table-nowrap align-middle mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($listeoppeff['commentaires'] as $commmentaire)
                                                                            {{-- expr --}}
                                                                            <tr>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" id="updateOppbtn" class="btn btn-primary ">Enregister les modifications</button>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
