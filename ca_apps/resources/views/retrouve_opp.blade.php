                                ...
                                <div class="card-body">
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                       ...
                                       {{--      
                                            ...
                                            @if (!empty($tel) )
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Recherche Opportunité - Filtre - [telephone] :{{$tel}}</h3></td>
                                            </tr>


                                             @elseif (!empty($namefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Recherche Opportunité - Filtre - [Nom ou Prénom] : <span style="font-weight:bold">{{$namefilter}}</span></h4></td>
                                            </tr>
                                            @elseif (!empty($plaquefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Recherche Opportunité - Filtre - [Plaque immatriculation] : <span style="font-weight:bold">{{$plaquefilter}}</span></h4></td>
                                            </tr>
                                            @else
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Recherche Opportunité</h3></td>
                                     ...
                                     @php
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{
                                                     is_null($listeprospection_element['echeance']) ? ' - ':
                                                    \Carbon\Carbon::parse($listeprospection_element['echeance'])->format('d-m-Y');}}</td>
                                                <td><a href="tel:{{$listeprospection_element['telephone']}}">{{$listeprospection_element['telephone']}}</a></td>
                                                ...
                                                <td> 
                                                    ...
                                                    @if (!empty($listeprospection_element['commentaires'] && count($listeprospection_element['commentaires']) > 0))
                                                        {{-- expr --}}
                                                         ...
                                                         @if ($listeprospection_element['commentaires'][0]['resultat']== 'rdvsouscription')
                                                            <span class="badge badge-label bg-secondary"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['commentaires'][0]['resultat']}}</span>
                                               ...
                                               {{--  <td><img height="50" src="{{$listeprospection_element['urlcarte_grise']}}" alt=""></td>
                                                ...
                                                {{--  @if ($listeprospection_element['commentaires'][0]['observation'])
                                                   
                                               
                                                <td>{{$listeprospection_element['affectation'][0]['agent_backoffice'][0]['lastname'].' '.$listeprospection_element['affectation'][0]['agent_backoffice'][0]['firstname']??' Non defini'}}</td> --}}
                                            


                                                @if ($listeprospection_element['affectation'])
                                                    {{-- expr --}}
                                                    ...
                                                    {{-- <a class="btn btn-primary" href="/enregister_note_propection/{{$listeprospection_element['id']}}">Commenter</a> --}}
                                                         ...
                                                         <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="{{$listeprospection_element['id']}}">
                                                                    <li> <a class="dropdown-item" href="/enregister_note_propection/{{$listeprospection_element['id']}}"> <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Commenter</a></li>
