                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                          @foreach ($listevehicule as $listevehicule_element)
                                            <tr>
                                                <td>{{$listevehicule_element['carfamily']['car_code']}}</td>
                                                <td>{{$listevehicule_element['carfamily']['brand']}}</td>
                                                <td>{{$listevehicule_element['carfamily']['type']}}</td>
                                                <td>{{$listevehicule_element['carfamily']['model']}}</td>
                                                <td>{{$listevehicule_element['date']}}</td>
                                                <td>{{$listevehicule_element['amount']}}</td>
                                                <td><a id="edit_car" href="/edit_car/{{$listevehicule_element['carfamily']['id'].'/'.$listevehicule_element['date']}}" class="btn btn-dark" >Modifier</a></td>
                                            </tr>
                                          @endforeach
                                    </table>
                                </div>
