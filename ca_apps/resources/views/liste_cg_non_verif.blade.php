                                ...
                                <div class="card-body">
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                           ...
                                           {{--  @else
                                            <tr style="background:lightgray;">
                                                <td  colspan="10"><h3 style="text-align:center;">Opportunitées Carte Grise non vérifiées</h3></td>
                                            </tr>--}}
                                            @endif 
                                            <tr>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                @if ($listeprospection_element['affectation'])
                                                 ...
                                                 <td>{{$listeprospection_element['affectation'][0]['agent_backoffice'][0]['firstname'] .' '.$listeprospection_element['affectation'][0]['agent_backoffice'][0]['lastname']  }}</td>
                                                 @else
                                                 <td><span class="badge badge-pill bg-danger" data-key="t-hot">Non affecté</span></td>
                                                @endif

                                                <td data-sort="{{$listeprospection_element['created_at']}}">{{\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y');}}</td>
