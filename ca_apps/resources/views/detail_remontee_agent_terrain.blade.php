                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Opportunitées remontées  par  {{$listeprospection[0]['agent_terrain']['lastname']??' Non defini'}}</h5>
                                </div>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="11"><h3 style="text-align:center;">Opportunitées remontées par {{$listeprospection[0]['agent_terrain']['lastname']??' Non defini'}} </h3></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td class="tel1">{{$listeprospection_element['telephone']}}</td>
                                                <td>
