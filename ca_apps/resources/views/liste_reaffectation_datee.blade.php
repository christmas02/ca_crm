   ...
   <!--datatable css-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Liste des Réaffectations</h4>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                   ...
                                   {{--  <form id="formdatefield" method="POST" action="/filter_reaffectation_bydate"  class="col-md-7" style="display:none">
                                            @csrf
                                            <div style=" display: inline-block;width: 170px;">
                                                <div>
                                                    <label for="basiInput" class="form-label">Debut affectation</label>
                                            ...
                                            <div   style=" display: inline-block;width: 170px;margin-left: 20px;">
                                                <div>
                                                    <label for="basiInput" class="form-label">Fin affectation</label>
                                    ...
                                    <form id="formagentfield" method="POST" action="/filter_reaffectation_bydate"  class="col-md-10">
                                        @csrf
                                        ...
                                        <div style=" display: inline-block;width: 170px;">
                                            <div>
                                                <label for="basiInput" class="form-label">Debut affectation</label>
                                                <input id="datedebut" type="date" name="debutaffect" class="form-control requiredField" id="basiInput" required>
                                            </div>
                                        </div> 
                                        ...
                                        <div   style=" display: inline-block;width: 170px;margin-left: 20px;">
                                            <div>
                                                <label for="basiInput" class="form-label">Fin affectation</label>
                                                <input id="datefin" type="date" name="finaffect" class="form-control requiredField" id="basiInput" required>
                                            </div>
                                        </div> 
                                        <div  style=" display: inline-block;margin-left: 20px;">
                                            <div class="mb-3">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            @if (!empty($debutaffect) && !empty($finaffect) )

                                                 <tr style="background:lightgray;">
                                                <td  colspan="12"><h4 style="text-align:center;"> Affectation - Filtre [{{$selectedAgent}} ]<span style="font-weight:bold"> DEBUT:</span> <span>{{\Carbon\Carbon::parse($debutaffect)->format('d-m-Y')}}</span> <span style="font-weight:bold"> FIN: </span> <span>{{\Carbon\Carbon::parse($finaffect)->format('d-m-Y')}}</span></h4></td>
                                            </tr>
                                             @else
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Réaffectations du {{date ('d-m-Y')}}</h3></td>
                                            </tr>
                                            @endif
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            @if (empty($listeprospection_element['commentaire']) && count($listeprospection_element['opportunite']) > 0 )
                                                {{-- expr --}}
                                            <tr>
                                                <td>{{$listeprospection_element['opportunites'][0]['plaque_immatriculation'] ?? 'Non defini'}}</td>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="{{$listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format('H:i:s')}}" >
                                                ...
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['opportunite']['echeance'])->format('d-m-Y H:i');}}</td>
                                                ...
                                                <td> 
                                                        ...
                                                        {{-- expr --}}
                                                         ...
                                                         @endif
                                                          ...
                                                          @if ($listeprospection_element['resultat']== 'poursuivre')
                                                ...
                                                <td><div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="{{$listeprospection_element['opportunite']['id']}}" style="padding: 10px;min-width: 300px;border: solid 2px #40518959;">
                                                                    {{$listeprospection_element['opportunite']['observation']}}
                                                                </div>
                                                            </div></td>
                                                <td>{{$listeprospection_element['agent_backoffice']['firstname'] .' '.$listeprospection_element['agent_backoffice']['lastname']  }}</td>
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y H:i');}}</td>
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['opportunite']['created_at'])->format('d-m-Y H:i');}}</td>
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="{{$listeprospection_element['opportunite']['id']}}">
                                                                    ...
                                                                    <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"   data-opp="{{$listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format('H:i:s')}}">  <i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Reaffecter</a></li>
    ...
    <script src="/assets/js/app.js"></script>
        ...
        <script>
            ...
            var check_reaf_aff = 2;// 1 pour affectation 2 pour reaffecation
            var currentOpp =0;
