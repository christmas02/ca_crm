                            ...
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                  ...
                                  @isset($finalfiltre)
                                    ...
                                    <p> {{$finalfiltre .' ' .$datefiltre_deb .' entre et ' .$datefiltre_fin }}</p>
                                      @endif
                                    <div class="col-md-2">
                                        ...
                                        <form id="formnamefield" method="POST" action="/liste_prospection_byagent_relance_searchname"  class="col-md-7" style="display:none">
                                            @csrf
                                        ...
                                        <form id="formtelfield" method="POST" action="/liste_prospection_byagent_relance_searchtel"  class="col-md-7" style="display:none">
                                            @csrf
                                            <div   style=" display: inline-block;width: 170px;">
                                                <div>
                                         ...
                                         <form id="formdatefield" method="POST" action="/listeprospectionbyagentrelancebydate"  class="col-md-7" style="display:block;">
                                            @csrf
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                           ...
                                           @if ($listeprospection_element['resultat'] != 'perdu' || $listeprospection_element['resultat'] != 'horscible')
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['plaque_immatriculation'] ?? 'Non défini'}}</td>
