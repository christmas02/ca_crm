                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($liste_canaux as $liste_canaux_element)


                                            <tr>
                                                <td>{{$liste_canaux_element['id']}}</td>
                                                <td>{{$liste_canaux_element['libelle']}}</td>
                                                <td>{{$liste_canaux_element['agent_backoffice']['lastname'].' '.$liste_canaux_element['agent_backoffice']['firstname']}}</td>
                                                <td>{{$liste_canaux_element['created_at']}}</td>
                                                @if ($liste_canaux_element['isactive'] == 1)
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="{{'edit_canal/'.$liste_canaux_element['id']}}"> Modifier</a>

                                                    <a class="btn btn-danger" href="{{'editcanal/'.$liste_canaux_element['id']}}"> supprimer</a>
                                                </td>
