                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="marque" class="form-control " placeholder="Marque" id="compnayNameinput" required  @if(isset($marque_cg)) value="{{$marque_cg}}" @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="model" class="form-control " placeholder="model" id="compnayNameinput" required @if(isset($model_cg)) value="{{$model_cg}}" @endif>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="energie" id="ForminputState" class="form-select" data-choices data-choices-sorting="true" required>
                                                            ...
                                                            <option @isset($energie_cg) 
                                                            @if (Str::lower($energie_cg) == 'essence')
                                                                 selected
                                                             @endif 
                                                            @endisset value="essence">Essence</option>
                                                            <option @isset($energie_cg)
                                                            @if(Str::lower($energie_cg) == 'diesel' || Str::lower($energie_cg) =='gasoil' )
                                                                 selected
                                                             @endif 
                                                            @endisset value="diesel">Diesel</option>
                                                        </select>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="mise_circulation" class="form-control maxlength10" placeholder="mise en circulation" id="compnayNameinput" required @if(isset($mise_circulation_cg)) value="{{\Carbon\Carbon::parse($mise_circulation_cg)->format('Y-m-d')}}" @endif>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nbreplace" class="form-control numberonly" placeholder="Nombre de place " id="compnayNameinput" required @isset($nbre_place_cg) value="{{$nbre_place_cg}}" @endisset>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="puissance" class="form-control numberonly" placeholder="5" id="puissance" required @if(isset($puissance_cg)) value="{{$puissance}}" @endif>
                                                    </div>
                                                </div>
