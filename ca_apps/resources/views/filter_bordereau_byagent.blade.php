                            ...
                            <div class="card">
                                <div class="card-header">
                                 ...
                                 <div id="filterform" class="row gy-4" style="padding-left: 20px;background: lavender;margin: 15px;">
                                         ...
                                         <form id="formtelfield" method="POST" action="/filter_bordereau_byagent"  class="col-md-10">
                                            ...
                                            <div class="col-md-4" style=" display: inline-block;margin-right:15px;">
                                                <label for="basiInput" class="form-label"> Agents </label>
                                                 <select id="selectagent" name="selectagent" class="form-select mb-3" aria-label="Default select example">
                                            ...
                                            <div  style=" display: inline-block;margin-left: 20px;">
                                                <div class="mb-3">
                                                    ...
                                                    <button style="width:200px" type="submit"  class="btn btn-primary">Filtrer</button>
                                                     ...
                                                     <a href="/liste_nvelle_opp_gagnee" style="width:200px" class="btn btn-success">Reinitialiser</a>
                                                </div>
                                            </div>
                                      ...
                                      <p><span style="font-weight:bold">AGENT:</span> <span>{{$foundagent[0]['firstname'].' '.$foundagent[0]['lastname']}}</span>  <span style="font-weight:bold">DATE DEBUT:</span> <span>{{$datedebut}}</span> <span style="font-weight:bold">DATE FIN: </span> <span>{{$datefin}}</span>   </p>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['lieuprospection']}}</td>
                                                <td>{{$listeprospection_element['primenet']}}</td>
