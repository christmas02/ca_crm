...
<html lang="fr" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
  <head>
    <meta charset="utf-8" />
        @if ($currentPage == 'liste_prospection_groupee')
           <title>ConseilsAssur - Affectation en cours </title>
        @elseif($currentPage == 'liste_prospection_byagent_relance_admin')
           <title>ConseilsAssur - Relances en cours</title>
        @elseif($currentPage == 'liste_prosprection_created_online')
           <title>ConseilsAssur - Opportunites par agent</title>
        @elseif($currentPage == 'liste_contrat')
           <title>ConseilsAssur - Contrats AN/RN detailés</title>
        @elseif($currentPage == 'liste_prospection_ferme')
              ...
              <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="d-flex align-items-center">
                    ...
                    <img class="rounded-circle header-profile-user" src="{{Session::get('profileImg')}}" alt="Header Avatar">
                    @else
                    ...
                    <span class="text-start ms-xl-2">
                      ...
                      <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Session::get('userlogin')}}</span>
                      <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">
                     
                      @if (Session::get('userprivilege') == 'niveau1') Full @endif
                      @if (Session::get('userprivilege') == 'niveau2') Intermédiaire @endif
                      @if (Session::get('userprivilege') == 'niveau3') Débutant @endif
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <!-- item-->
                  <h6 class="dropdown-header">Bienvenue {{Session::get('login')}}!</h6>
