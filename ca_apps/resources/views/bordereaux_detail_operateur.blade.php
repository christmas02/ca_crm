                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <tr style="background:lightgray;">
                                                @if (count($listeopportunite_tratee)>0)
                                                    {{-- expr --}}
                                              
                                                <td  colspan="13"><h3 style="text-align:center;">{{count($listeopportunite_tratee)}} Opportunités traitées  -  {{$listeopportunite_tratee[0]['agent_backoffice']['firstname'].' ' .$listeopportunite_tratee[0]['agent_backoffice']['lastname']}} </h3></td>
                                                {{-- @else
                                                <td  colspan="13"><h3 style="text-align:center;">Opportunités traitées  - {{$foundamin['firstname'].' '.$foundamin['lastname']}} </h3></td>--}}
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeopportunite_tratee as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['telephone2']}}</td>
                                                <td> 
                                                        {{-- expr --}}
                                                ...
                                                <td>{{number_format($listeprospection_element['primenet'], 0, '.', ' ')}}</td>
                                                <td>{{number_format($listeprospection_element['primettc'], 0, '.', ' ')}}</td>
                                               ...
                                               {{--  <td>
                                                ...
                                                <td>
                                                    {{-- <a href="/enregister_note_propection/{{$listeprospection_element['id']}}" type="button" class="btn btn-danger delete_btn"   >commenter</a> --}}
