                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Relance en cours du  {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')  }}</h3></td>
                                            </tr>
                                            @else
                                            <tr style="background:lightgray;">
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                           ...
                                           @if ($listeprospection_element['resultat'] != 'perdu' || $listeprospection_element['resultat'] != 'horscible')
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['id']}}</td>
                                                <td>
                                                    <div class="form-check">
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['observation']}}</td>
