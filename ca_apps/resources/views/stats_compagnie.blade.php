                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                   ...
                                   <form id="formtelfield" method="POST" action="/stat_compagnie"  class="col-md-10">
                                            @csrf
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Assureur du  {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')  }}</h3></td>
                                            </tr>
                                            @else
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Assureur du  {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</h3></td>
                                            </tr>
                                            @endisset
                                        ...
                                        <tbody> 
                                            ...
                                            @foreach ($stat_comp as $stat_comp_el)
                                            <tr>
                                                  <td>{{$stat_comp_el['assureur_actuel']}}</td>
                                                  <td>{{$stat_comp_el['totalprimenet']}}</td>
                                                  <td>{{$stat_comp_el['totalprimettc']}}</td>
                                                  <td>{{$stat_comp_el['nombre_contrat_rn']}}</td>
                                                   <td>{{$stat_comp_el['nombre_contrat_an']}}</td>
