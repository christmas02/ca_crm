          ...
          <div class="container-fluid">
                            ...
                            <form class="updateform" id="updateform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="phonenumber" value="{{$findAgent['PhoneNumber'] }}" class="form-control requiredField" >
                                  </div>
                                </div>
                                <!--end col-->
            ...
            <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Privilèges</h4>
                                </div>
                                <!-- end card header -->
                                ...
                                <div class="col-md-12 text-center">
                                   <button id="updatepriv" class="btn btn-dark" style="margin-right: 40px;" type="button">Mettre à jour les privileges</button>
                                </div>
