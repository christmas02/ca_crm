                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-switch form-switch-lg " dir="ltr" style="margin-top:30px;display: inline-block;float: right;">
                                        <input name="isactiv" type="checkbox" class="form-check-input" id="customSwitchsizelg" @if ($foundcanal[0]['isactive']==1)
                                          {{-- expr --}}
                                         checked=""@endif>
                                        @if ($foundcanal[0]['isactive']==1)
                                ...
                                <div >
                                  <div>
                                    ...
                                    <input type="text" name="libellecanal" class="form-control requiredField" value="{{$foundcanal[0]['libelle']}}" >
                                  </div>
                                </div>
                                <!--end col-->
