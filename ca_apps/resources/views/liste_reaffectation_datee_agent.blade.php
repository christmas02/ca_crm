                            ...
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                   ...
                                   {{--  <form id="formdatefield" method="POST" action="/filter_reaffectation_bydate"  class="col-md-7" style="display:none">
                                    ...
                                    <form id="formagentfield" method="POST" action="/filter_reaffectation_bydate_agent"  class="col-md-10">
                                        @csrf
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <{{-- tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Réaffecations du {{$debutaffect}}</h3></td>
                                            </tr> --}}

                                                 <tr style="background:lightgray;">
                                                <td  colspan="12"><h4 style="text-align:center;"> Affectation - Filtre  <span style="font-weight:bold"> DEBUT:</span> <span>{{\Carbon\Carbon::parse($debutaffect)->format('d-m-Y')}}</span> <span style="font-weight:bold"> FIN: </span> <span>{{\Carbon\Carbon::parse($finaffect)->format('d-m-Y')}}</span></h4></td>
                                            </tr>
                                             @else
                                                {{-- expr --}}
                                                <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Réaffecations du {{date ('d-m-Y')}}</h3></td>
                                            </tr>
                                            @endif
