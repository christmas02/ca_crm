                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: lavender;margin: 15px;">
                                    ...
                                    <form id="formnamefield" method="POST" action="/filter_contrat_byclientname_admin"  class="col-md-7" style="display:none">
                                        ...
                                        <form id="formtelfield" method="POST" action="/filter_contrat_bytel_admin"  class="col-md-7" style="display:none">
                                         ...
                                         <form id="formdatefield" method="POST" action="/liste_contrat_byagent_bydate"  class="col-md-7" style="display:none">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                      ...
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Contrats par agents - Filtre - [ {{$foundagent[0]['firstname'].' '.$foundagent[0]['lastname']}}]<span style="font-weight:bold">ECHEANCE DEBUT:</span> <span>{{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span>{{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</span></h4></td>
                                            </tr>

                                        @elseif (!empty($selectedagent) && $selectedagent == 'tous')
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Contrats par agents - Filtre - [Tous] <span style="font-weight:bold">ECHEANCE DEBUT:</span> <span>{{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span>{{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</span></h4></td>
                                            </tr>


                                        @elseif (!empty($telfiltre) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Contrats par agents - Filtre - [Telephone] : <span style="font-weight:bold">{{$telfiltre}}</span></h4></td>
                                                </tr> 


                                         @elseif (!empty($namefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Contrats par agents - Filtre - [Nom ou Prénom] : <span style="font-weight:bold">{{$namefilter}}</span></h4></td>
                                                </tr>

                                         @else 

                                         <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats par agents</h3></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['commentaire']['echeance'])->format('d-m-Y H:i');}}</td>
                                                @else
                                                <td> - </td>
                                                @endif
                                                 <td>{{\Carbon\Carbon::parse($listeprospection_element['commentaire']['daterelance'])->format('d-m-Y H:i');}}</td>
