                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Opportunites Fermees / Hors cibles / Perdues</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                         <form id="formnamefield" method="POST" action="/filter_prospection_ferme_nom"  class="col-md-7">
                                                @csrf
                                                <div   style=" display: inline-block;width: 170px;">
                                                    <div>
                                                        <label for="basiInput" class="form-label">Nom ou Prénoms</label>
                                                        <input id="namefilter" type="text" name="namefilter" class="form-control requiredField" id="basiInput" required placeholder="Ex: Alice">
                                                    </div>
                                                </div>
                                                <div  style=" display: inline-block;margin-left: 20px;">
                                                    <div class="mb-3">
                                                        <label class="form-label" style="display:block;">&nbsp;</label>
                                                        <button  type="submit" style="width:120px"  class="btn btn-primary">FILTRER</button>
                                                    </div>
                                                </div>
                                            ...
                                            <form id="formtelfield" method="POST" action="/filter_prospection_ferme_tel"  class="col-md-7" style="display:none">
                                                @csrf
                                                <div   style=" display: inline-block;width: 170px;">
                                                    <div>
                                             ...
                                             <form id="formdatefield" method="POST" action="/filter_prospection_ferme"  class="col-md-6" style="display:none">
                                                @csrf
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        ...
                                        @if (!empty($telfiltre) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="11"><h4 style="text-align:center;">Contrats par agents - Filtre - [Telephone] : <span style="font-weight:bold">{{$telfiltre}}</span></h4></td>
                                                </tr> 


                                         @elseif (!empty($namefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="11"><h4 style="text-align:center;">Contrats par agents - Filtre - [Nom ou Prénom] : <span style="font-weight:bold">{{$namefilter}}</span></h4></td>
                                                </tr>

                                        @else 

                                         <tr style="background:lightgray;">
                                                <td  colspan="11"><h3 style="text-align:center;">Opportunités fermées</h3></td>
                                            </tr>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                           ...
                                           @if ($listeprospection_element['resultat'] == 'perdu' || $listeprospection_element['resultat'] == 'horscible')
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="{{$listeprospection_element['opportunite']['id']}}" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td>{{$listeprospection_element['opportunite']['nom']}}</td>
                                                <td>{{$listeprospection_element['opportunite']['prenoms']}}</td>
                                                <td data-sort="{{$listeprospection_element['opportunite']['echeance']}}">{{\Carbon\Carbon::parse($listeprospection_element['opportunite']['echeance'])->format('d-m-Y H:i');}}</td>
                                                ...
                                                <td>
                                                 ...
                                                 {{-- @if (Session::get('userprivilege') == 'niveau1' && $listeprospection_element['affectations'] != null) 
                                                    <td>
