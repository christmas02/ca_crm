                                            ...
                                            <div class="py-4 px-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0"><span class="counter-value" data-target="{{$nombre_opp_remont}}">0</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0"><span class="counter-value" data-target="{{$statopp[0]['totalgagne'] ?? 0}}">0</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0"><span class="counter-value" data-target="{{$statopp[0]['totalprimenet'] ??0}}">0</span> Fcfa</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0"><span class="counter-value" data-target="{{$statopp[0]['totalprimettc']??0}}">0</span> Fcfa</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                            ...
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        @if ($statopp_antecedent[0]['totalprimenet']!=0 && $statopp_antecedent[0]['totalprimenet']!=null)
                                                         <h2 class="mb-0"><span class="counter-value" data-target="{{round(($statopp[0]['totalprimenet'] - $statopp_antecedent[0]['totalprimenet']) / $statopp_antecedent[0]['totalprimenet'] *100 ,2 )}}">0</span>%</h2>
                                                        @else 
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        @if ($evolu_contratrn>0)
                                                        <h5 class="text-success fs-14 mb-0">
                                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i> +{{$evolu_contratrn}} %
                                                        </h5>
                                                        @else
                                                         <h5 class="text-danger fs-14 mb-0">
                                                            <i class="ri-arrow-right-down-line fs-13 align-middle"></i> {{$evolu_contratrn}} %
                                                        </h5>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{$nombre_contrat_rn}}">0</span></h4>
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        @if ($evolu_contratan>0)
                                                        <h5 class="text-success fs-14 mb-0">
                                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i> +{{$evolu_contratan}} %
                                                        </h5>
                                                        @else
                                                         <h5 class="text-danger fs-14 mb-0">
                                                            <i class="ri-arrow-right-down-line fs-13 align-middle"></i> {{$evolu_contratan}} %
                                                        </h5>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{$nombre_contrat_an}}">0</span></h4>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        @if ($evolu_cartecg>0)
                                                        <h5 class="text-success fs-14 mb-0">
                                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i> +{{$evolu_cartecg}} %
                                                        </h5>
                                                        @else
                                                         <h5 class="text-danger fs-14 mb-0">
                                                            <i class="ri-arrow-right-down-line fs-13 align-middle"></i> {{$evolu_cartecg}} %
                                                        </h5>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{$carte_attest[0]['nbrecartegrise']}}">0</span></h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        {{-- <h5 class="text-muted fs-14 mb-0">
                                                         ...
                                                         @if ($evolu_attest>0)
                                                        <h5 class="text-success fs-14 mb-0">
                                                            <i class="ri-arrow-right-up-line fs-13 align-middle"></i> +{{$evolu_attest}} %
                                                        </h5>
                                                        @else
                                                         <h5 class="text-danger fs-14 mb-0">
                                                            <i class="ri-arrow-right-down-line fs-13 align-middle"></i> {{$evolu_attest}} %
                                                        </h5>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{$carte_attest[0]['nbreattestation']}}">0</span> </h4>
                                ...
                                <div class="card-body px-0">
                                    <ul class="list-inline main-chart text-center mb-0">
                                        <li class="list-inline-item chart-border-left me-0 border-0">
                                          @if (count($totalbyYear)!=0) 
                                            <h4 class="text-primary">{{$totalbyYear[0]['totalgagne']}} <span class="text-muted d-inline-block fs-13 align-middle ms-2">Gagnés</span></h4>
                                            @endif
                                        </li>
                                        <li class="list-inline-item chart-border-left me-0">
                                            @if (count($totalbyYear)!=0) 
                                            <h4>{{$totalbyYear[0]['totalperdue']}} <span class="text-muted d-inline-block fs-13 align-middle ms-2">Perdus</span>
                                            </h4>
                                            @endif
                                        </li>
                                        <li class="list-inline-item chart-border-left me-0">
                                             @if (count($totalbyYear)!=0) 
                                            <h4><span data-plugin="counterup">{{round(($totalbyYear[0]['totalgagne'] * 100)/$totalbyYear[0]['totaltraites'],2 )}}</span>%<span class="text-muted d-inline-block fs-13 align-middle ms-2"> Ratio</span></h4>
                                            @endif
                                        </li>
                                    </ul>
                                    ...
                                    <div class="table-responsive table-card">
                                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                             ...
                                             @foreach ($stat_conseilles as $stat_conseilles_element)

                                                <tr>
                                                    <td>{{$stat_conseilles_element['agent_backoffice']['id']}}</td>
                                                    <td>{{\Carbon\Carbon::parse($stat_conseilles_element['agent_backoffice']['created_at'])->format('d-m-Y')}}</td>
                                                    <td><img src="{{$stat_conseilles_element['agent_backoffice']['profile_picture'] ?? '/assets/images/users/user-dummy-img.jpg'}}" alt="" class="avatar-xs rounded-circle me-2">
                                                        <a href="dashboard-crm.html#javascript: void(0);" class="text-body fw-medium">{{$stat_conseilles_element['agent_backoffice']['lastname'].' '.$stat_conseilles_element['agent_backoffice']['firstname']}}</a>
                                                    </td>
                                                    <td><span class="badge badge-soft-success p-2">Debutant</span></td>
                                                    <td>
                                                        <div class="text-nowrap">{{number_format($stat_conseilles_element['sumprimenet'], 0, '.', ' ') ?? 0}} Fcfa</div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                                ...
                                                {{-- <tr>
                                                    ...
                                                    <td><img src="assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                        <a href="dashboard-crm.html#javascript: void(0);" class="text-body fw-medium">Sofia Cunha</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                        <a href="dashboard-crm.html#javascript: void(0);" class="text-body fw-medium">Luis Rocha</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="assets/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                        <a href="dashboard-crm.html#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a>
                                                    </td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <div class="d-flex justify-content-center align-items-center mb-4">
                                            <h2 class="me-3 ff-secondary mb-0">{{$statopp[0]['totaltraites']??0}}</h2>
                                            <div>
                                                <p class="text-muted mb-0">Opportunités traitées</p>
                                                <p class="text-success fw-medium mb-0">
                                                    <span class="badge badge-soft-success p-1 rounded-circle"><i class="ri-arrow-right-up-line"></i></span> +{{$statopp[0]['totalgagne'] ??0}} gagnées
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalgagne'] ??0}} </span>
                                                @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalgagne']!=null)
                                                    {{-- expr --}}
                                              
                                                <span class="percent"> {{round($statopp[0]['totalgagne']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                        ...
                                        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalrdvsouscription']??0}} </span>

                                                @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalrdvsouscription']!=null)
                                                    {{-- expr --}}
                                              
                                                <span class="percent"> {{round($statopp[0]['totalrdvsouscription']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                                  <span class="percent"> 0%</span>
                                                @endif
                                        ...
                                        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalpoursuivre']??0}}  </span>
                                                 @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalpoursuivre']!=null)
                                                    {{-- expr --}}
                                              
                                                <span class="percent"> {{round($statopp[0]['totalpoursuivre']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                                  <span class="percent"> 0%</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalreporte']??0}} </span>
                                                @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalreporte']!=null)
                                                    {{-- expr --}}
                                              
                                                <span class="percent"> {{round($statopp[0]['totalreporte']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                                  <span class="percent"> 0%</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalperdue']??0}} </span>
                                                @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalperdue']!=null)
                                                    {{-- expr --}}
                                                <span class="percent"> {{round($statopp[0]['totalperdue']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                                  <span class="percent"> 0%</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between py-2">
                                            ...
                                            <div>
                                                <span class="text-muted pe-5">{{$statopp[0]['totalhorscible']?? 0}} </span>
                                                @if ($statopp[0]['totaltraites']!=0 && $statopp[0]['totalhorscible']!=null)
                                              
                                                <span class="percent"> {{round($statopp[0]['totalhorscible']*100 / $statopp[0]['totaltraites'],2)}}</span> %
                                                @else
                                                  <span class="percent"> 0%</span>
                                                @endif
                              </div>
