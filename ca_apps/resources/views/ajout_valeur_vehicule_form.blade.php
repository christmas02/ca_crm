                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nbreplace" class="form-control numberonly" placeholder="Lieux de prospection" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="puissance" class="form-control numberonly" placeholder="" id="puissance" required>
                                                    </div>
                                                </div>
