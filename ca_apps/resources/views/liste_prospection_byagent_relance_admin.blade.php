                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                    <form id="formnamefield" method="POST" action="/filter_relance_name_admin"  class="col-md-7" style="display:none">
                                            @csrf
                                    ...
                                    <form id="formdate_ech_field" method="POST" action="/filter_relance_echeance_admin"  class="col-md-7" style="display:none">
                                            @csrf
                                            <div style=" display: inline-block;width: 170px;">
                                                <div>
                                    ...
                                    <form id="formdatefield" method="POST" action="/filter_relance_relance_admin"  class="col-md-7" style="display:none">
                                            @csrf
                                            <div style=" display: inline-block;width: 170px;">
                                                <div>
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                      ...
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [ {{$foundagent[0]['firstname'].' '.$foundagent[0]['lastname']}}]<span style="font-weight:bold">RELANCE DEBUT:</span> <span>{{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</span> <span style="font-weight:bold">RELANCE FIN: </span> <span>{{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</span></h4></td>
                                            </tr>

                                        @elseif (!empty($selectedagent) && $selectedagent == 'tous')
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Tous] <span style="font-weight:bold">RELANCE DEBUT:</span> <span>{{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</span> <span style="font-weight:bold">RELANCE FIN: </span> <span>{{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</span></h4></td>
                                            </tr>


                                        @elseif (!empty($telfiltre) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Telephone] : <span style="font-weight:bold">{{$telfiltre}}</span></h4></td>
                                                </tr> 


                                         @elseif (!empty($namefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Nom ou Prénom] : <span style="font-weight:bold">{{$namefilter}}</span></h4></td>
                                                </tr>

                                        
                                         @elseif (!empty($plaquefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Plaque] : <span style="font-weight:bold">{{$plaquefilter}}</span></h4></td>
                                                </tr>

                                         @else 

                                         <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Relance en cours</h3></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                           ...
                                           {{-- @if ($listeprospection_element['resultat'] != 'perdu' || $listeprospection_element['resultat'] != 'horscible') --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y H:i');}}</td>
                                                 <td>{{\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format(' H:i:s');}}</td>
                                                ...
                                                {{-- <td>{{\Carbon\Carbon::parse($listeprospection_element['opportunite']['created_at'])->format('d-m-Y ');}}</td> --}}
                                                <td>
