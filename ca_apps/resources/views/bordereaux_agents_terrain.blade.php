                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Remontées Agent Terrain  du  {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')  }}</h3></td>
                                            </tr>
                                            @else
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Remontées Agent Terrain du {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</h3></td>
                                            </tr>
                                            @endif
                                            <tr>
                                                 <th>Nom</th>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                @if ($listeprospection_element['agent_terrain']['id'] == 5 && $datefin !=null && $datefin <='2023-12-26')
                                                    {{-- expr --}}
                                                 <td>{{$listeprospection_element['nbrecartegrise'] +200}}</td>
                                                @else
                                                ...
                                                <td>
                                                    <a class="btn btn-dark" href="/details_remontes_agent/{{$listeprospection_element['agent_terrain']['id']}}">Details</a>
                                                </td>
                                            </tr>
                                          @endforeach
