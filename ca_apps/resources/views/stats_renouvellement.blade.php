                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Renouvellement du  {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')  }}</h3></td>
                                            </tr>
                                            @else
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Renvouellement du  {{date('d-m-Y')}}</h3></td>
                                            </tr>
                                            @endisset
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                  <td>{{$nbre_rn_eff}}</td>
                                                  <td>{{$nbre_rn_attendu}}</td>
                                                  <td>{{$nbre_rn_rattrap}}</td>
                                                  <td>{{$nbre_rn_non_eff}}</td>
                                                    @php
