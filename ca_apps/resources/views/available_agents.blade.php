<form class="tablelist-form" autocomplete="off">
    <div class="mb-3">
        ...
        <input name="dateaffect" type="date" id="date-field" class="form-control" data-provider="flatpickr" required data-date-format="d M, Y" data-enable-time required placeholder="Select date" value="{{date('Y-m-d')}}" />
    </div>
</form>
<table class="table table-nowrap">
    @foreach ($agents_dispo as $agents)
        <tr class="listagents_dispo">
            ...
            <td style="text-align:right;padding-right: 10px;"><a class="btn btn-primary setliv" data-idagent="{{$agents['id']}}" style="font-weight: bold;" href="#">affecter</a></td>
        </tr>
    @endforeach
</table>
