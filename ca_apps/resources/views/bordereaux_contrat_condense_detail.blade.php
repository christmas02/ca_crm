                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <tr style="background:lightgray;">
                                                @if (count($contrat_condens)>0)
                                                    {{-- expr --}}
                                              
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN detaillés -  {{$contrat_condens[0]['agent_backoffice']['firstname'].' ' .$contrat_condens[0]['agent_backoffice']['lastname']}} </h3></td>
                                                @else
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN detaillés - {{$foundamin['firstname'].' '.$foundamin['lastname']}} </h3></td>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($contrat_condens as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['periode_soucription'] . ' Mois'}}</td>
