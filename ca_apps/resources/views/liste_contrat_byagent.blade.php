                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                      ...
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Renouvellement - Filtre - <span style="font-weight:bold">{{$filtre}} DEBUT:</span> <span>{{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}}</span> <span style="font-weight:bold">{{$filtre}} FIN: </span> <span>{{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</span></h4></td>
                                            </tr>
                                        ...
                                        @elseif (!empty($telfiltre) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Renouvellement - Filtre - [Telephone] : <span style="font-weight:bold">{{$telfiltre}}</span></h4></td>
                                                </tr> 


                                         @elseif (!empty($namefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Renouvellement - Filtre - [Nom ou Prénom] : <span style="font-weight:bold">{{$namefilter}}</span></h4></td>
                                                </tr>

                                        
                                         @elseif (!empty($plaquefilter) )
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Renouvellement - Filtre - [Plaque] : <span style="font-weight:bold">{{$plaquefilter}}</span></h4></td>
                                                </tr>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                         ...
                                                         @if ($listeprospection_element['commentaire']['resultat'] == 'horscible')
                                                          ...
                                                          @endif
                                                           ...
                                                           @if ($listeprospection_element['commentaire']['resultat'] == 'reporte')
                                                         ...
                                                         @endif
                                                          ...
                                                          @if ($listeprospection_element['commentaire']['resultat']== 'perdu')
                                                            <span class="badge badge-label bg-danger"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['commentaire']['resultat']}}</span>
                                                         ...
                                                         @endif
                                                          ...
                                                          @if ($listeprospection_element['commentaire']['resultat']== 'poursuivre')
                                                         ...
                                                         @if ($listeprospection_element['commentaire']['resultat']== 'rdvsouscription')
                                                            <span class="badge badge-label bg-secondary"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['commentaire']['resultat']}}</span>
 ...
 --}}
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="{{$listeprospection_element['opportunite']['id']}}">
                                                                    ...
                                                                    {{-- <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"  data-opp="{{$listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['commentaire']['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['commentaire']['heure_relance'])->format('H:i:s')}}">  <i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Reaffecter</a></li> --}}
                                         ...
                                         @foreach ($liste_reaffectations as $liste_reaffectations_element)
                                            ...
                                            <tr>
                                               ...
                                               {{--   <td>{{$liste_reaffectations_element['primenet']}}</td>
                                                <td>{{$liste_reaffectations_element['primettc']}}</td> --}}
...
{{-- 
                                          ...
                                          @endforeach
                                           ...
                                           @foreach ($listeprospection_nc as $listeprospection_nc_elm)
                                                ...
                                                {{-- <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="{{$listeprospection_nc_elm['opportunite']['id'] .'|'. $listeprospection_nc_elm['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_nc_elm['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_nc_elm['heure_relance'])->format('H:i:s')}}" id="cardtableCheck01">
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                ...
                                                <td>{{\Carbon\Carbon::parse($listeprospection_nc_elm['echeance'])->format('d-m-Y H:i');}}</td>
                                                @else
                                                <td> - </td>
                                                @endif
                                                 <td>{{\Carbon\Carbon::parse($listeprospection_nc_elm['daterelance'])->format('d-m-Y H:i');}}</td>
                                                <td>
                                                ...
                                                <td> 
                                                    ...
                                                    {{-- @if (!empty($listeprospection_nc_elm['commentaire'] && count($listeprospection_nc_elm['commentaire']) > 0)) --}}
                                                        {{-- expr --}}
                                                         ...
                                                         @if ($listeprospection_nc_elm['resultat'] == 'horscible_rn'|| $listeprospection_nc_elm['resultat']== 'horscible')
                                                            <span class="badge badge-label bg-info"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_nc_elm['resultat']}}</span>
                                                          @endif

                                                           @if ($listeprospection_nc_elm['resultat'] == 'reporte_rn'|| $listeprospection_nc_elm['resultat']== 'reporte')
                                                            <span class="badge badge-label bg-warning"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_nc_elm['resultat']}}</span>

                                                         @endif


                                                          @if ($listeprospection_nc_elm['resultat']== 'perdu_rn'|| $listeprospection_nc_elm['resultat']== 'perdu')
                                                         ...
                                                         @endif
                                                          ...
                                                          @if ($listeprospection_nc_elm['resultat']== 'poursuivre_rn'|| $listeprospection_nc_elm['resultat']== 'poursuivre')
                                                            <span class="badge badge-label bg-dark"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_nc_elm['resultat']}}</span>

                                                         @endif


                                                          @if ($listeprospection_nc_elm['resultat']== 'rdvsouscription_rn'|| $listeprospection_nc_elm['resultat']== 'rdvsouscription')
