                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Recap Opportunites remontés</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Recap Opportunites</h5>
                                </div>
                                     ...
                                     <h2>FORMULAIRE DE RECHERCHE</h2>
                                        ...
                                        {{-- <div class="col-md-2">
                                            <label for="basiInput" class="form-label">Filtrer </label>
                                             <select id="selectfiltre" name="" class="form-select mb-3" aria-label="Default select example" required>
                                                ...
                                                <option value="date_rel">Date Rélance</option>
                                            </select>
                                        </div> --}}
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <form id="formdatefield" method="POST" action="/filter_recap_stat_opp">
                                            @csrf

                                            <div  style=" display: inline-block;width: 170px;">
                                                <label for="basiInput" class="form-label">Filtrer </label>
                                                 <select id="selectfiltre" name="statutdemande" class="form-select mb-3" aria-label="Default select example" required>
                                                    <option selected="selected" disabled="disabled" value="">choisir un filtre</option>
                                                     <option value="gagne">Gagné</option>
                                                    <option value="rdvsouscription">Rdv souscription</option>
                                                    <option value="poursuivre">Poursuivre</option>
                                                    <option value="reporte">Reporté</option>
                                                    <option value="perdu">Perdu</option>
                                                    <option value="horscible">Hors cible</option>
                                            ...
                                            <div  style=" display: inline-block;width: 170px;">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="datefiltre" type="date" name="datedebut" class="form-control requiredField" id="exampleInputdate">
                                                    </div>
                                            </div>
                                            ...
                                            <div  style=" display: inline-block;width: 170px;">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="datefiltre" type="date" name="datefin" class="form-control requiredField" id="exampleInputdate">
                                                    </div>
                                            </div>
                                        ...
                                        <button style="width:155px;display: none;height: 38px;" id="massaffectation" type="submit"  class="btn btn-success">Affecter en masse </button>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                       ...
                                       {{--      
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Recherche Opportunité</h3></td>
                                            </tr>
                                            @else
                                            <tr style="background:lightgray;">
                                                <td  colspan="10"><h3 style="text-align:center;">Opportunitées remontées et importées</h3></td>
                                            </tr>
                                            @endif --}}

                                              
                                             @if (!empty($datedebut) && !empty($datefin) && !empty($statutdemande))

                                                @php
                                                    $finalstatus ='';
                                                    if($statutdemande =='gagne') $finalstatus ='gagnée(s)';
                                                    if($statutdemande =='perdu') $finalstatus ='perdue(s)';
                                                    if($statutdemande =='reporte') $finalstatus ='reportée(s)';
                                                    if($statutdemande =='poursuivre') $finalstatus ='poursuivre';
                                                    if($statutdemande =='horscible') $finalstatus ='Hors cible(s)';
                                                    if($statutdemande =='rdvsouscription') $finalstatus ='Rendez-vous Souscription';
                                                @endphp
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">{{count($listeprospection)}} Opportunité(s) {{$finalstatus}} du {{\Carbon\Carbon::parse($datedebut)->format('d-m-Y')}} au {{\Carbon\Carbon::parse($datefin)->format('d-m-Y')}}</h3></td>
                                            </tr>
                                            @else

                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">{{count($listeprospection)}} Opportunité(s) gagne(s) au {{\Carbon\Carbon::parse($currentdate)->format('d-m-Y')}} </h3></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                {{--  <th data-orderable="false"> 
                                                 ...
                                                 <th>Telephone 1</th>
                                                 <th>Prime TTC</th>
                                                 <th>lieu Propection</th>
                                                 <th>Statut</th> 
                                           
                                                 <th>Affecté à</th>
                                                 @if (!empty($statutdemande) && $statutdemande =='rdvsouscription')
                                                    <th>Date Relance </th>
                                                 @else
                                                  <th>Enregistré le </th>
                                                 @endif
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($listeprospection as $listeprospection_element)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['plaque_immatriculation'] ?? 'Non defini'}}</td>
                                                {{-- <td>
                                                    <div class="form-check">
                                                ...
                                                <td>{{$listeprospection_element['opportunite']['telephone']}}</td>
                                                <td>{{$listeprospection_element['primettc']}}</td>
                                                <td>{{$listeprospection_element['opportunite']['lieuprospection'] ??'Non defini'}}</td>
                                                ...
                                                <td> 
                                                    ...
                                                    {{-- @if (!empty($listeprospection_element && count($listeprospection_element) > 0)) --}}
                                                        {{-- expr --}}
                                                   

                                                         @if ($listeprospection_element['resultat'] == 'horscible'||$listeprospection_element['resultat']== 'horscible_rn')
                                                            <span class="badge badge-label bg-info"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>
                                                          @endif

                                                           @if ($listeprospection_element['resultat'] == 'reporte'||$listeprospection_element['resultat']== 'reporte_rn')
                                                            <span class="badge badge-label bg-warning"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>

                                                         @endif


                                                          @if ($listeprospection_element['resultat']== 'perdu'||$listeprospection_element['resultat']== 'perdu_rn')
                                                            <span class="badge badge-label bg-danger"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>

                                                         @endif



                                                          @if ($listeprospection_element['resultat']== 'poursuivre'||$listeprospection_element['resultat']== 'poursuivre_rn')
                                                            <span class="badge badge-label bg-dark"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>

                                                         @endif


                                                         @if ($listeprospection_element['resultat']== 'gagne')
                                                           {{--  <div class="alert alert-success text-center display-6" role="alert">
                                                                <b style="text-transform: uppercase;"></b> 
                                                            </div> --}}

                                                            <span class="badge badge-label bg-success"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>

                                                         @endif


                                                         @if ($listeprospection_element['resultat']== 'rdvsouscription'||$listeprospection_element['resultat']== 'rdvsouscription_rn')
                                                            <span class="badge badge-label bg-secondary"><i class="mdi mdi-circle-medium"></i> {{$listeprospection_element['resultat']}}</span>
                                               ...
                                               {{--  <td><img height="50" src="{{$listeprospection_element['urlcarte_grise']}}" alt=""></td>
                                                ...
                                                <td>{{$listeprospection_element['agent_backoffice']['lastname'].' '.$listeprospection_element['agent_backoffice']['firstname']??' Non defini'}}</td>
                                                
                                                 @if ($listeprospection_element['resultat']!= 'rdvsouscription')
                                                <td>{{\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y H:i:s');}}</td>
                                                <td>
                                                    @endif

                                                @if ($listeprospection_element['resultat']== 'rdvsouscription')
                                                    {{-- expr --}}
                                                      <td>{{\Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y H:i:s');}}</td>
                                                <td>
                                                @endif
                                                    {{-- <a class="btn btn-primary" href="/enregister_note_propection/{{$listeprospection_element['id']}}">Commenter</a> --}}
                                                         ...
                                                         <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="{{$listeprospection_element['id']}}">
                                                                 ...
                                                                 {{-- @if (Session::get('userprivilege') == 'niveau1')  --}}
                                                                   @if (is_null($listeprospection_element['affectations']) || count($listeprospection_element['affectations'])<=0)   
                                                                    <li><a class="dropdown-item attrib_btn " data-type-aff="1" href="#" data-bs-toggle="modal"  data-opp="{{$listeprospection_element['id']}}">  <i class=" ri-list-check align-bottom me-2 text-muted"></i> Affecter</a></li>
                                                                     @else

                                                                     @php
                                               
                                                                        $heurerelance='00:00:00';
                                                                        $daterelance = date('Y-m-s');
                                                                        if(!empty($listeprospection_element && count($listeprospection_element)!=0)){

                                                                         $heurerelance = \Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format('H:i:s');


                                                                          $daterelance = \Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y');
                                                                        }
                                                                        @endphp

                                                                  
                                                                   
                                                                      <li><a class="dropdown-item attrib_btn" data-type-aff="2" href="#" data-bs-toggle="modal"  data-opp="{{$listeprospection_element['id'] .'|'. $listeprospection_element['echeance'] .'|'.$daterelance.'|'.$heurerelance}}">  <i class=" ri-list-check align-bottom me-2 text-muted"></i> Reaffecter</a></li>
                                                                    ...
                                                                    <li><a class="dropdown-item delete_btn " href="#" data-bs-toggle="modal"  data-opp="{{$listeprospection_element['id']}}">  <i class=" ri-delete-bin-fill align-bottom me-2 text-muted"></i> Supprimer</a></li>
