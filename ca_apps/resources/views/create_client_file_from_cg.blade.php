                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form id="createNote" class="formtoupdate" action="javascript:void(0);">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-md-6 col-xxl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Entrer votre nom" id="firstNameinput" name="edit_name" value="{{$nomclient_cg}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xxl-3">
                                                    ...
                                                    <label for="readonlyInput" class="form-label">Immatriculation </label>
                                                        <input name="edit_immatriculation" type="text" class="form-control plaque_imm" id="readonlyInput" value="{{$num_matricule_cg }}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputdate" class="form-label"> Echéance</label>
                                                <input type="date" name="dateecheance" class="form-control maxlength10" id="exampleInputdate" @if(isset($lastcommentaire)) value="{{\Carbon\Carbon::parse($lastcommentaire['echeance'])->format('Y-m-d')}}" @endif>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xxl-3">
                                            <div class="mb-3">
