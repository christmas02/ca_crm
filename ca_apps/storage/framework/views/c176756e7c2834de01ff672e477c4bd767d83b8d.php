                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="marque" class="form-control " placeholder="Marque" id="compnayNameinput" required  <?php if(isset($marque_cg)): ?> value="<?php echo e($marque_cg); ?>" <?php endif; ?>>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="model" class="form-control " placeholder="model" id="compnayNameinput" required <?php if(isset($model_cg)): ?> value="<?php echo e($model_cg); ?>" <?php endif; ?>>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="energie" id="ForminputState" class="form-select" data-choices data-choices-sorting="true" required>
                                                            ...
                                                            <option <?php if(isset($energie_cg)): ?> 
                                                            <?php if(Str::lower($energie_cg) == 'essence'): ?>
                                                                 selected
                                                             <?php endif; ?> 
                                                            <?php endif; ?> value="essence">Essence</option>
                                                            <option <?php if(isset($energie_cg)): ?>
                                                            <?php if(Str::lower($energie_cg) == 'diesel' || Str::lower($energie_cg) =='gasoil' ): ?>
                                                                 selected
                                                             <?php endif; ?> 
                                                            <?php endif; ?> value="diesel">Diesel</option>
                                                        </select>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="mise_circulation" class="form-control maxlength10" placeholder="mise en circulation" id="compnayNameinput" required <?php if(isset($mise_circulation_cg)): ?> value="<?php echo e(\Carbon\Carbon::parse($mise_circulation_cg)->format('Y-m-d')); ?>" <?php endif; ?>>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nbreplace" class="form-control numberonly" placeholder="Nombre de place " id="compnayNameinput" required <?php if(isset($nbre_place_cg)): ?> value="<?php echo e($nbre_place_cg); ?>" <?php endif; ?>>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <?php
                                                            if(isset($puissance_cg))
                                                            $puissance = preg_replace('/[^0-9]/', '', $puissance_cg);  
                                                        ?>
                                                        <label for="puissance" class="form-label">Puissance</label>
                                                        <input type="text" name="puissance" class="form-control numberonly" placeholder="5" id="puissance" required <?php if(isset($puissance_cg)): ?> value="<?php echo e($puissance); ?>" <?php endif; ?>>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="valeurneuve" class="form-control numberonly" placeholder="reduction " id="valeurneuve" required>
                                                    </div>
                                                </div>
...
function chech_uploadedfile(selfile){
    ...
    return hasErrorf;
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/simulation_form_manuel.blade.php ENDPATH**/ ?>