   ...
   <!--datatable css-->
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['commentaire']['echeance'])->format('d-m-Y H:i')); ?></td>
                                                <?php else: ?>
                                                <td> - </td>
                                                <?php endif; ?>
                                                 <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['commentaire']['daterelance'])->format('d-m-Y H:i')); ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="/prospection_full_details/<?php echo e($listeprospection_element['opportunite']['id']); ?>">Details</a>
                                                </td>
                                            </tr>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_contrat_byagent_bydate.blade.php ENDPATH**/ ?>