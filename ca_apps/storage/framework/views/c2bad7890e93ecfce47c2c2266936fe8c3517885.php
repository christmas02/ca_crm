                                    ...
                                    <div class="live-preview">
                                        <form id="createNote" class="formtoupdate" action="javascript:void(0);">
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-md-6 col-xxl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Entrer votre nom" id="firstNameinput" name="edit_name" value="<?php echo e($nomclient_cg); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xxl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Entrer votre nom" id="firstNameinput" name="edit_prenoms" value="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6 col-xxl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control numberonly telReg requiredField" placeholder="Entrer votre numero de telephone" id="firstNameinput" name="edit_tel" value="">
                                                    </div>
                                                 </div>
                                                 ...
                                                 <div class="col-md-6 col-xxl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control numberonly telReg" placeholder="Entrer votre numero de telephone" id="firstNameinput" name="edit_tel2" value="">
                                                    </div>
                                                 </div>
                                                ...
                                                <div class="col-md-6 col-xxl-3">
                                                    ...
                                                    <label for="readonlyInput" class="form-label">Lieu Prospection</label>
                                                        <input name="edit_lieuprospection" type="text" class="form-control" id="readonlyInput" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xxl-3">
                                                    ...
                                                    <label for="readonlyInput" class="form-label">Immatriculation </label>
                                                        <input name="edit_immatriculation" type="text" class="form-control plaque_imm" id="readonlyInput" value="<?php echo e($num_matricule_cg); ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="dateecheance" class="form-control maxlength10" id="exampleInputdate" <?php if(isset($lastcommentaire)): ?> value="<?php echo e(\Carbon\Carbon::parse($lastcommentaire['echeance'])->format('Y-m-d')); ?>" <?php endif; ?>>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xxl-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6 col-xxl-3">
                                            ...
                                            <?php if(isset($lastcommentaire)): ?>
                                                 ...
                                                 <?php if(in_array(12, $usersprivileges)): ?> 
                                                    ...
                                                    <option value="rdvsouscription_rn">Rdv souscription</option>
                                                    <option value="poursuivre_rn">Poursuivre</option>
                                                    <option value="reporte_rn">Reporté</option>
                                                    <option value="perdu_rn">Perdu</option>
                                                    <option value="horscible_rn">Hors cible</option>
                                                <?php else: ?>
                                                <option value="gagne">Gagné</option>
                                                    ...
                                                    <div class=" form-radio-primary">
                                                        ...
                                                        <div class="mx-auto">
                                                            ...
                                                            <div >
                                                                ...
                                                                <input name="preuve_paiement" class="form-control" type="file" >
                                                            </div>
                                        ...
                                        <div class="col-md-6 col-xxl-3">
                                                    ...
                                                    <div class=" form-radio-primary">
                                                        ...
                                                        <div class="mx-auto">
                                                            ...
                                                            <div >
                                                                <span class="msg_file" style="color: red;margin-left: 10px;display: none;"> fichier invalide</span>
                                                                <input name="avenant" class="form-control" type="file" >
                                                            </div>
                                                ...
                                                <div class="col-md-6 col-xxl-3">
                                                    ...
                                                    <div class="live-preview">
                                                        <div class="hstack gap-2 flex-wrap"> 
                                                            ...
                                                            <input type="radio" class="btn-check" name="etatdiscours" id="success-outlined-discours" value="OK" >
                                                            <label class="btn btn-outline-success" for="success-outlined-discours">Discours OK</label>

                                                            <input type="radio" class="btn-check" name="etatdiscours" id="danger-outlined-discours" value="NOK" >
...
$('input[type="file"]').each(function() {
 ...
 function chech_uploadedfile(selfile){
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/create_client_file_from_cg.blade.php ENDPATH**/ ?>