              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Ajouter un vehicule dans l'Argus</h4>
                      ...
                      <div class="row gy-4">
                        ...
                        <div class="col-md-7" style="margin: 0 auto">
                            ...
                            <div class="alert alert-success" role="alert" style="display:none">
                                                    <strong> Vehicule enregistré avec succès! </strong>  <b> <a href="/vehicule_list">Voir la liste des vehicules</a></b> en savoir
                                                </div>
                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                 ...
                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="typevehicule" id="ForminputState" class="form-select" data-choices data-choices-sorting="true">
                                                           <option selected value="">Choisir...</option>
                                                            <?php $__currentLoopData = $car_type_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typelist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                 <option value="<?php echo e($typelist['type']); ?>"><?php echo e($typelist['type']); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="nombreplace" class="form-control requiredField" >
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="annsortie" class="form-control requiredField" >
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="valeurneuve" class="form-control requiredField" >
                                  </div>
                                </div>
                                <!--end col-->
  ...
  crossorigin="anonymous"></script>
    ...
    $(document).ready(function () {
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/create_vehicule.blade.php ENDPATH**/ ?>