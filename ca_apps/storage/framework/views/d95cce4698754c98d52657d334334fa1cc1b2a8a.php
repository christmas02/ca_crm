                        ...
                        <div class="col-xxl-6"  style="margin:auto">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Lecteur carte grise</h4>
                                    ...
                                    <div class="live-preview">
                                        ...
                                        <form id="createprospectform" action="javascript:void(0);">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="text-end">
                                                        <button id="saveprospect" type="submit" class="btn btn-primary">Suivant</button>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                                            ...
                                            <div id="resultintro" class="mt-4" style="display:none">
                                                 <p class="text-center">Voici les informations structurées extraites de l'image de la carte grise</p>
                                            </div>
            ...
            if (!hasError) {
                ...
                $.ajax({
                  ...
                  success: function(response){
                    ...
                    btnclicked.removeClass('not-active').html('Suivant'); 

                    $('#resultintro').css('display','block');
                     $('#cginfos').html(response);
...
function chech_uploadedfile(selfile){
    ...
    return hasErrorf;
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/lecteur_carte_grise.blade.php ENDPATH**/ ?>