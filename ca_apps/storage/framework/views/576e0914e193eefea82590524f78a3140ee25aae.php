   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Opportunitées en Doublons</h5>
                                </div>
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                        <form id="formtelfield" method="POST" action="/listeprosprectionbyteldoublon"  class="col-md-7" style="display:none">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form id="formnamefield" method="POST" action="/listeprosprectionbynamedoublon"  class="col-md-7">
                                            <?php echo csrf_field(); ?>
                                            <div   style=" display: inline-block;width: 170px;">
                                                <div>
                                         ...
                                         <form id="formdatefield" method="POST" action="/listeprosprection_doublonbydate"  class="col-md-7" style="display:none">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Opportunitées remontées en doublon</h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="10"><h3 style="text-align:center;">Opportunitées remontées en doublon</h3></td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['echeance'])->format('d-m-Y')); ?></td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger delete_btn"   data-opp="<?php echo e($listeprospection_element['id']); ?>">Supprimer</button>
                                                </td>
                                                <?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_doublon.blade.php ENDPATH**/ ?>