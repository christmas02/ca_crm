   ...
   <!--datatable css-->
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <
                                                ...
                                                <td  colspan="12"><h4 style="text-align:center;"> Affectation - Filtre  <span style="font-weight:bold"> DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($debutaffect)->format('d-m-Y')); ?></span> <span style="font-weight:bold"> FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($finaffect)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>
                                             <?php else: ?>
                                                
                                                <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Réaffecations du <?php echo e(date ('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_reaffectation_datee_agent.blade.php ENDPATH**/ ?>