                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <?php if(!empty($datedebut) && !empty($datefin) &&  $typefiltre =='RELANCE'  ): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Mes Opportunites - Filtre - [RELANCE]<span style="font-weight:bold">RELANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">RELANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>


                                     <?php elseif(!empty($datedebut) && !empty($datefin) &&  $typefiltre =='ECHEANCE'): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Mes Opportunites - Filtre - [ECHEANCE]<span style="font-weight:bold">ECHEANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>

                                        <?php elseif(!empty($selectedagent) && $selectedagent == 'tous'): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Mes opportunites - Filtre - [Tous] <span style="font-weight:bold"> DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold"> FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>


                                        <?php elseif(!empty($telfiltre) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Mes opportunites - Filtre - [Telephone] : <span style="font-weight:bold"><?php echo e($telfiltre); ?></span></h4></td>
                                                </tr> 


                                         <?php elseif(!empty($namefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Mes opportunites - Filtre - [Nom ou Prénom] : <span style="font-weight:bold"><?php echo e($namefilter); ?></span></h4></td>
                                                </tr>

                                        
                                         <?php elseif(!empty($plaquefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Mes opportunites - Filtre - [Plaque] : <span style="font-weight:bold"><?php echo e($plaquefilter); ?></span></h4></td>
                                                </tr>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $liste_relances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $liste_relances_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($liste_relances_element['opportunite']['id'] .'|'. $liste_relances_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($liste_relances_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($liste_relances_element['heure_relance'])->format('H:i:s').'|'. $liste_relances_element['primenet'].'|'. $liste_relances_element['primettc'].'|'. $liste_relances_element['periode_soucription'].'|'. $liste_relances_element['assureur_actuel']); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo e($liste_relances_element['opportunite']['nom']); ?></td>
                                                <td><?php echo e($liste_relances_element['opportunite']['prenoms']); ?></td>
                                                <td data-sort='<?php echo e($liste_relances_element['echeance']); ?>'><?php echo e(\Carbon\Carbon::parse($liste_relances_element['echeance'])->format('d-m-Y')); ?></td>
                                                <td data-sort='<?php echo e($liste_relances_element['daterelance']); ?>'><?php echo e(\Carbon\Carbon::parse($liste_relances_element['daterelance'])->format('d-m-Y H:i')); ?></td>
                                                 <td data-sort="\Carbon\Carbon::parse($liste_relances_element['heure_relance'])->format(' H:i:s');"><?php echo e(\Carbon\Carbon::parse($liste_relances_element['heure_relance'])->format(' H:i:s')); ?></td>
                                          ...
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           ...
                                           <?php $__currentLoopData = $liste_reaffectations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $liste_reaffectations_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td data-sort="<?php echo e(\Carbon\Carbon::parse($liste_reaffectations_element['echeance'])->format('d-m-Y')); ?>"><?php echo e(\Carbon\Carbon::parse($liste_reaffectations_element['echeance'])->format('d-m-Y')); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($liste_reaffectations_element['opportunite']['id']); ?>">
                                                                    ...
                                                                    <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"   data-opp="<?php echo e($liste_reaffectations_element['opportunite']['id'] .'|'. $liste_reaffectations_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($liste_reaffectations_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($liste_reaffectations_element['heure_relance'])->format('H:i:s').'|'. $liste_reaffectations_element['primenet'].'|'. $liste_reaffectations_element['primettc'].'|'. $liste_reaffectations_element['periode_soucription'].'|'. $liste_reaffectations_element['assureur_actuel']); ?>">  <i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Reaffecter</a></li>
                                          ...
                                          <?php $__currentLoopData = $nouvelle_opp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nouvelle_opp_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($nouvelle_opp_element['idopportunite']); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo e($nouvelle_opp_element['opportunites'][0]['nom']); ?></td>
                                                <td><?php echo e($nouvelle_opp_element['opportunites'][0]['prenoms']); ?></td>
                                                <td data-sort="<?php echo e($nouvelle_opp_element['opportunites'][0]['echeance']); ?>"><?php echo e(\Carbon\Carbon::parse($nouvelle_opp_element['opportunites'][0]['echeance'])->format('d-m-Y')); ?></td>
                                                ...
                                                <td> 
                                                    ...
                                                    <?php if(array_key_exists('commentaire', $nouvelle_opp_element) && !empty($nouvelle_opp_element['commentaire'] && count($nouvelle_opp_element['commentaire']) > 0)): ?>
                                                        
                                                   

                                                         <?php if($nouvelle_opp_element['commentaires'][0]['resultat'] == 'horscible'|| $nouvelle_opp_element['commentaires'][0]['resultat'] == 'horscible_rn'): ?>
                                                          ...
                                                          <?php endif; ?>
                                                           ...
                                                           <?php if($nouvelle_opp_element['commentaires'][0]['resultat'] == 'reporte'||$nouvelle_opp_element['commentaires'][0]['resultat'] == 'reporte_rn'): ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($nouvelle_opp_element['opportunites'][0]['id']); ?>">
                                                                    ...
                                                                    <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"  data-opp="<?php echo e($nouvelle_opp_element['idopportunite']); ?>">  <i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Affecter</a></li>
                                          ...
                                          <?php $__currentLoopData = $listeprospectioncreated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospectioncreated_el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospectioncreated_el['id']); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                ...
                                                <td data-sort="<?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['echeance'])->format('d-m-Y')); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['echeance'])->format('d-m-Y')); ?></td>
                                                <td>-</td>
                                                <td>-</td>
                                                 <td>-</td>
                                                 <td>
                                                ...
                                                <td> <?php if(!empty($listeprospectioncreated_el['commentaires'] && count($listeprospectioncreated_el['commentaires']) > 0)): ?>
                                                         ...
                                                         <?php if($listeprospectioncreated_el['commentaires'][0]['resultat'] == 'horscible'||$listeprospectioncreated_el['commentaires'][0]['resultat'] == 'horscible_rn'): ?>
                                                          ...
                                                          <?php endif; ?>
                                                           ...
                                                           <?php if($listeprospectioncreated_el['commentaires'][0]['resultat'] == 'reporte'|| $listeprospectioncreated_el['commentaires'][0]['resultat'] == 'reporte_rn'): ?>
                                                         ...
                                                         <?php endif; ?>
                                                          ...
                                                          <?php if($listeprospectioncreated_el['commentaires'][0]['resultat']== 'perdu'|| $listeprospectioncreated_el['commentaires'][0]['resultat']== 'perdu_rn'): ?>
                                                         ...
                                                         <?php endif; ?>
                                                          ...
                                                          <?php if($listeprospectioncreated_el['commentaires'][0]['resultat']== 'poursuivre'|| $listeprospectioncreated_el['commentaires'][0]['resultat']== 'poursuivre_rn'): ?>
                                                         ...
                                                         <?php endif; ?>
                                                          ...
                                                          <?php if($listeprospectioncreated_el['commentaires'][0]['resultat']== 'rdvsouscription'||$listeprospectioncreated_el['commentaires'][0]['resultat']== 'rdvsouscription_rn'): ?>
                                                            <span class="badge badge-label bg-secondary"><i class="mdi mdi-circle-medium"></i> <?php echo e($liste_reaffectations_element['resultat']); ?></span>
                                                         <?php endif; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospectioncreated_el['id']); ?>">
                                                                    ...
                                                                    <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospectioncreated_el['id']); ?>"><i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Affecter</a></li>
  ...
  console.log(table.settings())
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_opportunite.blade.php ENDPATH**/ ?>