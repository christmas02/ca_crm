            ...
            <div class="page-content">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-4">
                            <div class="text-center mb-4 pb-2">
                                ...
                                <?php
                                  $array=  explode('-',$model);
                                ?>
                                <h4 class="fw-semibold fs-22"><?php echo e($marque .' '.$array[0]); ?></h4>
                                <p class=" mb-4 fs-15"><?php echo e('Energie : '.$energie.' | Puissance :'.$puissance.' | Mise en circulation: '.$mise_circulation.' | Age Vehicule: '.$agevehicule .' ans '); ?></p>
                                <h6 class="fw-semibold fs-22"> Valeur Venale : <?php echo e(number_format($valeur_venale, 0, '.', ' ')); ?> Fcfa</h6>
                                <h6 class="fw-semibold fs-22"> Valeur Neuve : <?php echo e(number_format($valeur_neuve, 0, '.', ' ')); ?> Fcfa</h6>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="marque" class="form-control " value="<?php echo e($marque); ?>" placeholder="Marque" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="model" class="form-control" value="<?php echo e($model); ?>" placeholder="model" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="energie" id="ForminputState" class="form-select" data-choices data-choices-sorting="true" required>
                                                            ...
                                                            <option <?php if($energie =='essence'): ?> selected <?php endif; ?> value="essence">Essence</option>
                                                            <option <?php if($energie =='diesel'): ?> selected <?php endif; ?> value="diesel">Diesel</option>
                                                        </select>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="mise_circulation" class="form-control maxlength10" placeholder="mise en circulation" value="<?php echo e($mise_circulation); ?>" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nbreplace" class="form-control numberonly" placeholder="Nombre de place " value="<?php echo e($nbreplace); ?>" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="puissance" class="form-control numberonly" placeholder="5" id="puissance"  value="<?php echo e($puissance); ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="valeurneuve" class="form-control numberonly" placeholder="reduction " id="valeurneuve" value="<?php echo e($valeur_neuve); ?>" required >
                                                    </div>
                                                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <?php if($prime_finale_tout_risque >0 && $agevehicule < 5 && !isset($nodata)): ?>
                                ...
                                <div class="row g-0">
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tout_risque,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/An </span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tout_risque *0.56,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/6mois</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tout_risque *0.6,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/3mois</span></h2>
                                            </div>
                        ...
                        <?php endif; ?>
                         ...
                         <?php if(($prime_finale_tiers_simple >0 && $agevehicule >12) ||( $agevehicule <5 && $agevehicule !=0) && !isset($nodata)): ?>
                        <div class="col-lg-6">
                                ...
                                <div class="row g-0">
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_simple,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted"> /An</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_simple *0.56,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/6mois</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_simple *0.6,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/3mois</span></h2>
                                            </div>
                        ...
                        <?php if($prime_finale_tiers_complet >0  && $agevehicule >=5 && $agevehicule <=12 && !isset($nodata)): ?>
                        <div class="col-lg-6">
                                ...
                                <div class="row g-0">
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_complet,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/An</span></h2>
                                            </div>

                                             <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_complet *0.56,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/6mois</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_complet *0.6,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/3mois</span></h2>
                                            </div>
                         ...
                         <?php endif; ?>
                        <!--end row-->
                         <?php if($prime_finale_tiers_ameliore >0  && $agevehicule <=12 && !isset($nodata)): ?>
                        <div class="col-lg-6">
                            <div class="card pricing-box ribbon-box ribbon-fill text-center">
                                <div class="ribbon ribbon-primary">Reco</div>
                                <div class="row g-0">
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_ameliore,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/An</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_ameliore *0.56,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/6mois</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_ameliore *0.6,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/3mois</span></h2>
                                            </div>
                         ...
                         <?php endif; ?>
                        <!--end col-->
                         <?php if($prime_finale_tiers_collision >0 && $agevehicule <=5 && !isset($nodata)): ?>
                        <div class="col-lg-6">
                            <div class="card pricing-box text-center">
                                <div class="row g-0">
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_collision,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/An </span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_collision *0.56,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/6mois</span></h2>
                                            </div>

                                            <div class="py-4">
                                                <h2><?php echo e(number_format($prime_finale_tiers_collision *0.6,0, '.', ' ')); ?> <sup><small> FCFA</small></sup><span class="fs-13 text-muted">/3mois</span></h2>
                                            </div>
    ...
    <script>
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/cotation.blade.php ENDPATH**/ ?>