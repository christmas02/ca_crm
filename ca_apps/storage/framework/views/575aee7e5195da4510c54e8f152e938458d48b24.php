                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="canal" id="ForminputState" class="form-select" data-choices data-choices-sorting="true">
                                                            ...
                                                            <?php $__currentLoopData = $liste_canal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $canal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                 <option value="<?php echo e($canal['id']); ?>"><?php echo e($canal['libelle']); ?></option>
...
function chech_uploadedfile(selfile){
    ...
    return hasErrorf;
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/create_prospection_form.blade.php ENDPATH**/ ?>