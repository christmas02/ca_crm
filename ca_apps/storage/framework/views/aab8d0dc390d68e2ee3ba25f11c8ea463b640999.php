   ...
   <!--datatable css-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Liste des vehicule de l'Argus</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Vehicules</h5>
                                </div>

                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                     <h2>FORMULAIRE DE RECHERCHE</h2>
                                   <form id="formtelfield" method="POST" action="/filter_listevehiculees"  class="col-md-10">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Liste des vehicules de l' ARGUS</h3></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listevehicule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listevehicule_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($listevehicule_element['carfamily']['car_code']); ?></td>
                                                <td><?php echo e($listevehicule_element['carfamily']['brand']); ?></td>
                                                <td><?php echo e($listevehicule_element['carfamily']['type']); ?></td>
                                                <td><?php echo e($listevehicule_element['carfamily']['model']); ?></td>
                                                <td><?php echo e($listevehicule_element['date']); ?></td>
                                                <td><?php echo e($listevehicule_element['amount']); ?></td>
                                                <td><a id="edit_car" href="/edit_car/<?php echo e($listevehicule_element['carfamily']['id'].'/'.$listevehicule_element['date']); ?>" class="btn btn-dark" >Modifier</a></td>
                                            </tr>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_vehicule.blade.php ENDPATH**/ ?>