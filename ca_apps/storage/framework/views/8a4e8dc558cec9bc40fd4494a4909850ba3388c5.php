   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                <div class="card-header">
                                 ...
                                 <div id="filterform" class="row gy-4" style="padding-left: 20px;background: lavender;margin: 15px;">
                                      ...
                                      <p><span style="font-weight:bold">AGENT:</span> <span><?php echo e($foundagent[0]['firstname'].' '.$foundagent[0]['lastname']); ?></span>  <span style="font-weight:bold">DATE DEBUT:</span> <span><?php echo e($datedebut); ?></span> <span style="font-weight:bold">DATE FIN: </span> <span><?php echo e($datefin); ?></span>   </p>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/filter_bordereau_byagent.blade.php ENDPATH**/ ?>