   ...
   <!--datatable css-->
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Recherche Relance en cours , critère [Téléphone ]: <?php echo e($listeprospection[0]['telephone']); ?> </h3></td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                          ...
                                          <?php if(!empty($listeprospection_element['commentaires'])): ?>;
                                             
                                           <?php if($listeprospection_element['commentaires'][0]['resultat'] != 'perdu' || $listeprospection_element['commentaires'][0]['resultat'] != 'horscible'): ?>

                                            <tr>
                                                
                                                <td><?php echo e($listeprospection_element['plaque_immatriculation'] ??'Non défini'); ?></td>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_element['id'] .'|'. $listeprospection_element['commentaires'][0]['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['heure_relance'])->format('H:i:s')); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo e($listeprospection_element['nom']); ?></td>
                                                <td><?php echo e($listeprospection_element['prenoms']); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['echeance'])->format('d-m-Y H:i')); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['daterelance'])->format('d-m-Y H:i')); ?></td>
                                                 <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['heure_relance'])->format(' H:i:s')); ?></td>
                                                <td><?php echo e($listeprospection_element['telephone']); ?></td>
                                                <td><?php echo e($listeprospection_element['observation']); ?></td>

                                                <td><?php echo e($listeprospection_element['commentaires'][0]['agent_backoffice']['firstname'].' '.$listeprospection_element['commentaires'][0]['agent_backoffice']['lastname']); ?></td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                          <button type="button" class="btn btn-dark attrib_btn" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['id'] .'|'. $listeprospection_element['commentaires'][0]['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['heure_relance'])->format('H:i:s')); ?>">Reaffecter</button>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                                            <?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent_relance_name_admin.blade.php ENDPATH**/ ?>