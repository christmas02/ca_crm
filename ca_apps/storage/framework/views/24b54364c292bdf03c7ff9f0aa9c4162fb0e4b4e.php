   ...
   <!--datatable css-->
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <tr style="background:lightgray;">
                                                <?php if(count($contrat_condens)>0): ?>
                                                    
                                              
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN detaillés -  <?php echo e($contrat_condens[0]['agent_backoffice']['firstname'].' ' .$contrat_condens[0]['agent_backoffice']['lastname']); ?> </h3></td>
                                                <?php else: ?>
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN detaillés - <?php echo e($foundamin['firstname'].' '.$foundamin['lastname']); ?> </h3></td>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $contrat_condens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospection_element['periode_soucription'] . ' Mois'); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/bordereaux_contrat_condense_detail.blade.php ENDPATH**/ ?>