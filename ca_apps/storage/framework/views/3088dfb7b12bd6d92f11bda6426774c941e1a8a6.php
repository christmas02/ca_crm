   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <form id="formnamefield" method="POST" action="/findoppbyname"  class="col-md-7">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form id="formplaquefield" method="POST" action="/findoppbyimmatricul"  class="col-md-7" style="display:none">
                                            <?php echo csrf_field(); ?>
                                            <div   style=" display: inline-block;width: 170px;">
                                                <div>
                                        ...
                                        <form id="formtelfield" method="POST" action="/findoppbytel"  class="col-md-7" style="display:none">
                                            <?php echo csrf_field(); ?>
                                            <div   style=" display: inline-block;width: 170px;">
                                                <div>
                                        ...
                                        <thead>
                                            ...
                                            <?php if(!empty($tel) ): ?>
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Recherche Opportunité - Filtre - [telephone] :<?php echo e($tel); ?></h3></td>
                                            </tr>


                                             <?php elseif(!empty($namefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Recherche Opportunité - Filtre - [Nom ou Prénom] : <span style="font-weight:bold"><?php echo e($namefilter); ?></span></h4></td>
                                            </tr>
                                            <?php elseif(!empty($plaquefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Recherche Opportunité - Filtre - [Plaque immatriculation] : <span style="font-weight:bold"><?php echo e($plaquefilter); ?></span></h4></td>
                                            </tr>
                                            <?php else: ?>
                                             <tr style="background:lightgray;">
                                     ...
                                     <?php
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(is_null($listeprospection_element['echeance']) ? ' - ':
                                                    \Carbon\Carbon::parse($listeprospection_element['echeance'])->format('d-m-Y')); ?></td>
                                                <td><a href="tel:<?php echo e($listeprospection_element['telephone']); ?>"><?php echo e($listeprospection_element['telephone']); ?></a></td>
                                                ...
                                                <td> 
                                                    ...
                                                    <?php if(!empty($listeprospection_element['commentaires'] && count($listeprospection_element['commentaires']) > 0)): ?>
                                                        
                                                   

                                                         <?php if($listeprospection_element['commentaires'][0]['resultat'] == 'horscible'): ?>
                                                            <span class="badge badge-label bg-info"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>
                                                          <?php endif; ?>

                                                           <?php if($listeprospection_element['commentaires'][0]['resultat'] == 'reporte'): ?>
                                                            <span class="badge badge-label bg-warning"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>

                                                         <?php endif; ?>


                                                          <?php if($listeprospection_element['commentaires'][0]['resultat']== 'perdu'): ?>
                                                            <span class="badge badge-label bg-danger"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>

                                                         <?php endif; ?>



                                                          <?php if($listeprospection_element['commentaires'][0]['resultat']== 'poursuivre'): ?>
                                                            <span class="badge badge-label bg-dark"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>

                                                         <?php endif; ?>


                                                         <?php if($listeprospection_element['commentaires'][0]['resultat']== 'gagne'): ?>
                                                           

                                                            <span class="badge badge-label bg-success"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>

                                                         <?php endif; ?>


                                                         <?php if($listeprospection_element['commentaires'][0]['resultat']== 'rdvsouscription'): ?>
                                                            <span class="badge badge-label bg-secondary"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaires'][0]['resultat']); ?></span>
                                                ...
                                                <?php if($listeprospection_element['affectation']): ?>
                                                    
                                               
                                                <td><?php echo e($listeprospection_element['affectation'][0]['agent_backoffice'][0]['lastname'].' '.$listeprospection_element['affectation'][0]['agent_backoffice'][0]['firstname']??' Non defini'); ?></td>
                                                <?php else: ?>
                                                <td> Non affecté</td>

                                                <?php endif; ?>

                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y H:i:s')); ?></td>
                                                <td>
                                                         ...
                                                         <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_element['id']); ?>">
                                                                    <li> <a class="dropdown-item" href="/enregister_note_propection/<?php echo e($listeprospection_element['id']); ?>"> <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Commenter</a></li>

                                                                 
                                                                   <?php if(count($listeprospection_element['affectation'])<=0): ?>   
                                                                    <li><a class="dropdown-item attrib_btn " data-type-aff="1" href="#" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['id']); ?>">  <i class=" ri-list-check align-bottom me-2 text-muted"></i> Affecter</a></li>
                                                                     <?php else: ?>
                                                                     ...
                                                                     <?php
                                                                        ...
                                                                        if(!empty($listeprospection_element['commentaires'] && count($listeprospection_element['commentaires'])!=0)){



                                                                         $heurerelance = \Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['heure_relance'])->format('H:i:s');


                                                                          $daterelance = \Carbon\Carbon::parse($listeprospection_element['commentaires'][0]['daterelance'])->format('d-m-Y');
                                                                        }

                                                                        $echeance = $listeprospection_element['echeance'] ;
                                                                        // ?? $listeprospection_element['commentaires'][0]['echeance'];
                                                                        ?>

                                                                  
                                                                      <?php if(!empty($listeprospection_element['commentaires'] && count($listeprospection_element['commentaires'])!=0)): ?>
                                                                      <li><a class="dropdown-item attrib_btn" data-type-aff="2" href="#" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['id'] .'|'. $echeance .'|'.$daterelance.'|'.$heurerelance .'|'. $listeprospection_element['commentaires'][0]['primenet'].'|'. $listeprospection_element['commentaires'][0]['primettc'].'|'. $listeprospection_element['commentaires'][0]['periode_soucription'].'|'. $listeprospection_element['commentaires'][0]['assureur_actuel']); ?>">  <i class=" ri-list-check align-bottom me-2 text-muted"></i> Reaffecter</a></li>
                                                                    ...
                                                                    <li><a class="dropdown-item delete_btn " href="#" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['id']); ?>">  <i class=" ri-delete-bin-fill align-bottom me-2 text-muted"></i> Supprimer</a></li>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/retrouve_opp.blade.php ENDPATH**/ ?>