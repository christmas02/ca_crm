   ...
   <!--datatable css-->
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                      ...
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [ <?php echo e($foundagent[0]['firstname'].' '.$foundagent[0]['lastname']); ?>]<span style="font-weight:bold">RELANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">RELANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>

                                        <?php elseif(!empty($selectedagent) && $selectedagent == 'tous'): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Tous] <span style="font-weight:bold">RELANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">RELANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>


                                        <?php elseif(!empty($telfiltre) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Telephone] : <span style="font-weight:bold"><?php echo e($telfiltre); ?></span></h4></td>
                                                </tr> 


                                         <?php elseif(!empty($namefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Nom ou Prénom] : <span style="font-weight:bold"><?php echo e($namefilter); ?></span></h4></td>
                                                </tr>

                                        
                                         <?php elseif(!empty($plaquefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Relance en cours - Filtre - [Plaque] : <span style="font-weight:bold"><?php echo e($plaquefilter); ?></span></h4></td>
                                                </tr>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format('H:i:s')); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y H:i')); ?></td>
                                                 <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format(' H:i:s')); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent_relance_admin.blade.php ENDPATH**/ ?>