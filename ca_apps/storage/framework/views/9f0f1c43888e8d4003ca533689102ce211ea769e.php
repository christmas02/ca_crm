   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Nouvelles Opportunités qui me sont affectées</h5>
                                </div>
                                 ...
                                 <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                        <form id="formtelfield" method="POST" action="/listeprosprectionbytel_agent"  class="col-md-7" style="display:none">
                                            <?php echo csrf_field(); ?>
                                         ...
                                         <form id="formdatefield" method="POST" action="/filter_liste_prospection_byagent"  class="col-md-7" style="display:block">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div  style=" display: inline-block;width: 170px;">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="datefiltre_deb" type="date" name="datefiltredeb" class="form-control requiredField" id="exampleInputdate" required>
                                                    </div>
                                            </div>
                                            <div  style=" display: inline-block;width: 170px;">
                                                    <div class="mb-3">
                                                        <label for="exampleInputdate" class="form-label"> Date fin</label>
                                                        <input id="datefiltre_fin" type="date" name="datefiltrefin" class="form-control requiredField" id="exampleInputdate" required>
                                                    </div>
                                            </div>
                                            <div  style=" display: inline-block;margin-left: 20px;">
                                                <div class="mb-3">
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="/enregister_note_propection/<?php echo e($listeprospection_element['opportunites'][0]['id']); ?>">Commenter</a>
                                                </td>
                                          ...
                                          <?php $__currentLoopData = $listeprospectioncreated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospectioncreated_el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospectioncreated_el['plaque_immatriculation'] ?? 'Non défini'); ?></td>
                                                ...
                                                <td><?php echo e($listeprospectioncreated_el['lieuprospection']); ?></td>
                                                <td><?php echo e($listeprospectioncreated_el['observation']); ?></td>
                                               
                                                
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="/enregister_note_propection/<?php echo e($listeprospectioncreated_el['id']); ?>">Commenter</a>
                                                </td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent.blade.php ENDPATH**/ ?>