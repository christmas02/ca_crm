<form class="tablelist-form" autocomplete="off">
    <div class="mb-3">
        ...
        <input type="date" id="date-field" name="dateaffect"class="form-control" data-provider="flatpickr" required data-date-format="d M, Y" data-enable-time required placeholder="Select date" value="<?php echo e(date('Y-m-d')); ?>" />
    </div>
</form>
<table class="table table-nowrap">
    <?php $__currentLoopData = $agents_dispo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="listagents_dispo">
            ...
            <td style="text-align:right;padding-right: 10px;"><a class="btn btn-primary setlivmass" data-idagent="<?php echo e($agents['id']); ?>" style="font-weight: bold;" href="#">affecter</a></td>
        </tr>
...
<?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/available_agents_mass.blade.php ENDPATH**/ ?>