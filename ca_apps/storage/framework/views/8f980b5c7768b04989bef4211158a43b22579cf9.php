 ...
 ?>
   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        ...
                                        <?php if(!empty($telfiltre) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="11"><h4 style="text-align:center;">Contrats par agents - Filtre - [Telephone] : <span style="font-weight:bold"><?php echo e($telfiltre); ?></span></h4></td>
                                                </tr> 


                                         <?php elseif(!empty($namefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="11"><h4 style="text-align:center;">Contrats par agents - Filtre - [Nom ou Prénom] : <span style="font-weight:bold"><?php echo e($namefilter); ?></span></h4></td>
                                                </tr>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           ...
                                           <?php if($listeprospection_element['resultat'] == 'perdu' || $listeprospection_element['resultat'] == 'horscible'): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_element['opportunite']['id']); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo e($listeprospection_element['opportunite']['nom']); ?></td>
                                                <td><?php echo e($listeprospection_element['opportunite']['prenoms']); ?></td>
                                                <td data-sort="<?php echo e($listeprospection_element['opportunite']['echeance']); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospection_element['opportunite']['echeance'])->format('d-m-Y H:i')); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_ferme.blade.php ENDPATH**/ ?>