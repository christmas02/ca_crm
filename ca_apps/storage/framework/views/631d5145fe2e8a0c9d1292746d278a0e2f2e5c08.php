   ...
   <!--datatable css-->
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <?php if(!empty($datedebut) && !empty($datefin) &&!empty($finalAgent) ): ?>
         
 
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h4 style="text-align:center;"> Opportunites par agent - Filtre [<?php echo e($finalAgent); ?> ]<span style="font-weight:bold"> DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold"> FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(empty($listeprospection_element['commentaire']) && count($listeprospection_element['opportunites']) > 0 ): ?>
                                                
                                            <tr>
                                                <td><?php echo e($listeprospection_element['opportunites'][0]['plaque_immatriculation'] ?? 'Non defini'); ?></td>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_element['idopportunite']); ?>" >
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td>
                                                <td><?php echo e($listeprospection_element['opportunites'][0]['nom']); ?></td>
                                                <td><?php echo e($listeprospection_element['opportunites'][0]['prenoms']); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['opportunites'][0]['echeance'])->format('d-m-Y H:i')); ?></td>
                                                <td><?php echo e($listeprospection_element['opportunites'][0]['telephone']); ?></td> 
                                                <td> 
                                                ...
                                                <td><div class="dropdown">
                                                                <a href="#" role="button" id="<?php echo e($listeprospection_element['opportunites'][0]['id']); ?>" data-bs-toggle="dropdown" aria-expanded="false">
                                                                  Afficher     <i class="ri-eye-fill"></i>
                                                                </a>
                                                                <div class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_element['opportunites'][0]['id']); ?>" style="padding: 10px;min-width: 300px;border: solid 2px #40518959;">
                                                                    <?php echo e($listeprospection_element['opportunites'][0]['observation']); ?>

                                                                </div>
                                                            </div></td>
                                                <td><?php echo e($listeprospection_element['agent_backoffice'][0]['firstname'] .' '.$listeprospection_element['agent_backoffice'][0]['lastname']); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['opportunites'][0]['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_element['opportunites'][0]['id']); ?>">
                                                                    <li> <a class="dropdown-item" href="/enregister_note_propection/<?php echo e($listeprospection_element['opportunites'][0]['id']); ?>"> <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Commenter</a></li>
                                          ...
                                          <?php $__currentLoopData = $listeprospectioncreated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospectioncreated_el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['echeance'])->format('d-m-Y H:i')); ?></td>
                                                 <td><?php echo e($listeprospectioncreated_el['telephone']); ?></td>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospectioncreated_el['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_groupee.blade.php ENDPATH**/ ?>