                        ...
                        <div class="col-xxl-6"  style="margin:auto">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Formulaire d'ajout vehicule</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="marque" class="form-control maxlength10" placeholder="peugeot" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nbreplace" class="form-control numberonly" placeholder="406n" id="compnayNameinput" required>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="marque" class="form-label">Type</label>
                                                        <input type="text" name="type" class="form-control " placeholder="berline" id="marque" required>
                                                    </div>
                                                </div>

                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="bns" class="form-label">Nombre de place</label>
                                                        <input type="text" name="bns" class="form-control numberonly" placeholder="5" id="bns" required>
                                                    </div>
                                                </div>
...
function chech_uploadedfile(selfile){
    ...
    return hasErrorf;
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/ajout_vehicule_form.blade.php ENDPATH**/ ?>