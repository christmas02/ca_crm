   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                   ...
                                   <form id="formtelfield" method="POST" action="/filter_bordereau_ag_terrain"  class="col-md-10">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Remontées Agent Terrain  du  <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Remontées Agent Terrain du <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                                 <th>Nom</th>
                                                 <th>Prenoms</th>
                                                 <th>Opportunite remontées</th>
                                                 <th>Nombre carte grise</th>
                                                 <th>Nombre attestation</th>
                                                 <th>Nombre Doublons </th>
                                                 <th>Details</th>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if($listeprospection_element['agent_terrain']['id'] == 5 && $datefin !=null && $datefin <='2023-12-26'): ?>
                                                    
                                                 <td><?php echo e($listeprospection_element['nbrecartegrise'] +200); ?></td>
                                                <?php else: ?>
                                                 <td><?php echo e($listeprospection_element['nbrecartegrise']); ?></td>
                                                <?php endif; ?>
                                               
                                                <td><?php echo e($listeprospection_element['nbreattestation']); ?></td>
                                                <td><?php echo e($listeprospection_element['nbredoublons']); ?></td>
                                                <td>
                                                    <a class="btn btn-dark" href="/details_remontes_agent/<?php echo e($listeprospection_element['agent_terrain']['id']); ?>">Details</a>
                                                </td>
                                            </tr>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/bordereaux_agents_terrain.blade.php ENDPATH**/ ?>