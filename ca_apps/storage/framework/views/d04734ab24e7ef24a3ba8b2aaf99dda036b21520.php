                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="marque" class="form-control requiredField" value="<?php echo e($cardetails[0]['brand']); ?>">
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" value="<?php echo e($cardetails[0]['brand']); ?>" name="model" class="form-control requiredField" >
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" value="<?php echo e($cardetails[0]['type']); ?>" name="typevehicule" class="form-control requiredField" >
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" value="<?php echo e($cardetails[0]['places']); ?>" name="nombreplace" class="form-control requiredField" >
                                  </div>
                                </div>
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text"  value="<?php echo e($cardetails[0]['carsvalues'][0]['date']); ?>" name="annsortie" class="form-control requiredField" >
                                  </div>
                                </div>
                                 ...
                                 <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text"  value="<?php echo e($cardetails[0]['power']); ?>" name="puissance" class="form-control requiredField" >
                                  </div>
                                </div>

                                <input type="hidden"  value="<?php echo e($cardetails[0]['id']); ?>" name="carid">
                                <input type="hidden"  value="<?php echo e($cardetails[0]['car_code']); ?>" name="car_code">

                                <div class=" col-md-6">
                                  <div>
                                    <label for="labelInput" class="form-label">Valeur neuve</label>
                                    <input type="text"  value="<?php echo e($cardetails[0]['carsvalues'][0]['amount']); ?>" name="valeurneuve" class="form-control requiredField" >
                                  </div>
                                </div>
                                <!--end col-->
  ...
  crossorigin="anonymous"></script>
    ...
    $(document).ready(function () {
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/edit_vehicule.blade.php ENDPATH**/ ?>