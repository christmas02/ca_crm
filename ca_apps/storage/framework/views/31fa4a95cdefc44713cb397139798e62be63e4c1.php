   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                      <?php if(!empty($foundagent) ): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [ <?php echo e($foundagent[0]['firstname'].' '.$foundagent[0]['lastname']); ?>]<span style="font-weight:bold">ECHEANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>

                                        <?php elseif(!empty($selectedagent) && $selectedagent == 'tous'): ?>
                                      <tr style="background:lightgray;">
                                                <td  colspan="13"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Tous] <span style="font-weight:bold">ECHEANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>


                                        <?php elseif(!empty($telfiltre) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Telephone] : <span style="font-weight:bold"><?php echo e($telfiltre); ?></span></h4></td>
                                                </tr> 


                                         <?php elseif(!empty($namefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="13"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Nom ou Prénom] : <span style="font-weight:bold"><?php echo e($namefilter); ?></span></h4></td>
                                                </tr>

                                        
                                         <?php elseif(!empty($plaquefilter) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="14"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Plaque] : <span style="font-weight:bold"><?php echo e($plaquefilter); ?></span></h4></td>
                                                </tr>



                                        <?php elseif(!empty($datefiltre_deb) && !empty($datefiltre_fin) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="14"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Date echeance] :  <span style="font-weight:bold">ECHEANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datefiltre_deb)->format('d-m-Y')); ?></span> <span style="font-weight:bold">ECHEANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefiltre_fin)->format('d-m-Y')); ?></span></h4></td>
                                                </tr>


                                        <?php elseif(!empty($datefiltrel_fin) && !empty($datefiltrel_deb) ): ?>
                                            <tr style="background:lightgray;">
                                                    <td  colspan="14"><h4 style="text-align:center;">Affectations AN/RN - Filtre - [Date relance] :  <span style="font-weight:bold">RELANCE DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($datefiltrel_deb)->format('d-m-Y')); ?></span> <span style="font-weight:bold">RELANCE FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($datefiltrel_fin)->format('d-m-Y')); ?></span></h4></td>
                                                </tr>
                                        ...
                                        <tbody> 
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospection_element['opportunite']['plaque_immatriculation']); ?></td>
                                                 <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['commentaire']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['commentaire']['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['commentaire']['heure_relance'])->format('H:i:s').'|'. $listeprospection_element['commentaire']['primenet'].'|'. $listeprospection_element['commentaire']['primettc'].'|'. $listeprospection_element['commentaire']['periode_soucription'].'|'. $listeprospection_element['commentaire']['assureur_actuel']); ?>" id="cardtableCheck01">
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                </td> 
                                                ...
                                                <td><?php echo e($listeprospection_element['commentaire']['periode_soucription']); ?></td>
                                                <td> 
                                                    
                                                   
                                                    <?php if(!empty($listeprospection_element['commentaire'] && count($listeprospection_element['commentaire']) > 0)): ?>
                                                        
                                                   

                                                         <?php if($listeprospection_element['commentaire']['resultat'] == 'horscible_rn'): ?>
                                                            <span class="badge badge-label bg-info"><i class="mdi mdi-circle-medium"></i> <?php echo e($listeprospection_element['commentaire']['resultat']); ?></span>
                                                          <?php endif; ?>

                                                           <?php if($listeprospection_element['commentaire']['resultat'] == 'reporte_rn'): ?>
                                                         ...
                                                         <?php endif; ?>
                                                          ...
                                                          <?php if($listeprospection_element['commentaire']['resultat']== 'perdu_rn'): ?>
                                                         ...
                                                         <?php endif; ?>
                                                          ...
                                                          <?php if($listeprospection_element['commentaire']['resultat']== 'poursuivre_rn'): ?>
                                                         ...
                                                         <?php if($listeprospection_element['commentaire']['resultat']== 'rdvsouscription_rn'): ?>
                                                ...
                                                <td><?php echo e($listeprospection_element['commentaire']['primenet']); ?></td>
                                                <td><?php echo e($listeprospection_element['commentaire']['primettc']); ?></td>
                                                ...
                                                <td>
                                                     ...
                                                     <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_element['opportunite']['id']); ?>">
                                                                    ...
                                                                    <li><a class="dropdown-item " href="/prospection_full_details/<?php echo e($listeprospection_element['opportunite']['id']); ?>">  <i class=" ri-list-check align-bottom me-2 text-muted"></i> Details</a></li>

                                                                    <li> <a class="dropdown-item histo_rn_btn"href="#"data-opp="<?php echo e($listeprospection_element['opportunite']['id']); ?>"> <i class="ri-stack-line align-bottom me-2 text-muted"></i> Historique RN</a></li>

                                                                     <li><a class="dropdown-item attrib_btn" href="#" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['commentaire']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['commentaire']['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['commentaire']['heure_relance'])->format('H:i:s')); ?>">  <i class=" ri-arrow-left-right-line align-bottom me-2 text-muted"></i> Reaffecter</a></li>
                                          ...
                                          <?php $__currentLoopData = $listeprospection_nc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_nc_elm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                <td> - </td> 
                                                <td><?php echo e($listeprospection_nc_elm['opportunite']['plaque_immatriculation']); ?> </td>

                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input checkboxOpp" type="checkbox" value="<?php echo e($listeprospection_nc_elm['opportunite']['id'] .'|'. $listeprospection_nc_elm['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_nc_elm['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_nc_elm['heure_relance'])->format('H:i:s').'|'. $listeprospection_nc_elm['primenet'].'|'. $listeprospection_nc_elm['primettc'].'|'. $listeprospection_nc_elm['periode_soucription'].'|'. $listeprospection_nc_elm['assureur_actuel']); ?>" id="cardtableCheck01">
                                                        <label class="form-check-label" for="cardtableCheck01"></label>
                                                    </div>
                                                ...
                                                <td data-sort="<?php echo e($listeprospection_nc_elm['echeance']); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospection_nc_elm['echeance'])->format('d-m-Y ')); ?></td>
                                                <?php else: ?>
                                                <td> - </td>
                                                <?php endif; ?>
                                                 <td data-sort="<?php echo e($listeprospection_nc_elm['daterelance']); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospection_nc_elm['daterelance'])->format('d-m-Y ')); ?></td>
                                                <td>
                                                ...
                                                <td><?php echo e($listeprospection_nc_elm['periode_soucription']); ?></td>
                                                ...
                                                <td><?php echo e($listeprospection_nc_elm['primenet']); ?></td>
                                                <td><?php echo e($listeprospection_nc_elm['primettc']); ?></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_nc_elm['opportunite']['id']); ?>">
                                                                    ...
                                                                    <li> <a class="dropdown-item histo_rn_btn"href="#"data-opp="<?php echo e($listeprospection_nc_elm['opportunite']['id']); ?>"> <i class="ri-stack-line align-bottom me-2 text-muted"></i> Historique RN</a></li>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_contrat_byagent_admin.blade.php ENDPATH**/ ?>