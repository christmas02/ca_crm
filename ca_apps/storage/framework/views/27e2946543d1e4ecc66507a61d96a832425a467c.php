		                                    ...
		                                    <div class="text-center">
		                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
		                                        	...
		                                        	<?php if(Session::get('profileImg') !='' || Session::get('profileImg') != null): ?>
		                                        		 ...
		                                        		 <img src="<?php echo e(Session::get('profileImg')); ?>" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
		                                        	<?php else: ?>
		                                        ...
		                                        <h5 class="fs-16 mb-1"><?php echo e(Session::get('userfirstname') . ' '.Session::get('userlastname')); ?></h5>
		                                        <p class="text-muted mb-0" style="color:black; font-weight: bold;">
		                                        	...
		                                        	<?php elseif(Session::get('userprivilege') =='niveau2'): ?>
		                                                ...
		                                                <div class="row">
		                                                    <div class="col-lg-6">
		                                                        <div class="mb-3">
		                                                            ...
		                                                            <input type="text" class="form-control" id="firstnameInput" name="firstname" placeholder="Entrer votre prenom" value="<?php echo e(Session::get('userfirstname')); ?>">
		                                                        </div>
		                                                    </div>
		                                                    <!--end col-->
		                                                    <div class="col-lg-6">
		                                                        <div class="mb-3">
		                                                            ...
		                                                            <input type="text" class="form-control" id="lastnameInput" name="lastname" placeholder="Entrer votre nom" value="<?php echo e(Session::get('userlastname')); ?>">
		                                                        </div>
		                                                    </div>
		                                                    <!--end col-->
		                                                    <div class="col-lg-6">
		                                                        <div class="mb-3">
		                                                            ...
		                                                            <input type="text" class="form-control" id="phonenumberInput" name="phonenumber" placeholder="Entrer votre numero de telephone" value="<?php echo e(Session::get('PhoneNumber')); ?>">
		                                                        </div>
		                                                    </div>
		                                                    <!--end col-->
		                                                    ...
		                                                    <div class="col-lg-6">
		                                                        <div class="mb-3">
		                                                            ...
		                                                            <input type="text" class="form-control" id="emailInput" name="login" placeholder="Entrer votre login" value="<?php echo e(Session::get('userlogin')); ?>">
		                                                        </div>
		                                                    </div>
		                                                    <!--end col-->
...
function chech_uploadedfile(selfile){
   ...
   <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/profile.blade.php ENDPATH**/ ?>