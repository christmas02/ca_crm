   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                             <?php if($datedebut !== null  && $datefin !== null && $datedebut != $datefin ): ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Assureur du  <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Stats Assureur du  <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php endif; ?>
                                        ...
                                        <tbody> 
                                            ...
                                            <?php $__currentLoopData = $stat_comp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat_comp_el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                  <td><?php echo e($stat_comp_el['assureur_actuel']); ?></td>
                                                  <td><?php echo e($stat_comp_el['totalprimenet']); ?></td>
                                                  <td><?php echo e($stat_comp_el['totalprimettc']); ?></td>
                                                  <td><?php echo e($stat_comp_el['nombre_contrat_rn']); ?></td>
                                                   <td><?php echo e($stat_comp_el['nombre_contrat_an']); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/stats_compagnie.blade.php ENDPATH**/ ?>