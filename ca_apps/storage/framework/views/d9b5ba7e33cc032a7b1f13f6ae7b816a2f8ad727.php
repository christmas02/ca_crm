   ...
   <!--datatable css-->
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Relance en cours du  <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:lightgray;">
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           ...
                                           <?php if($listeprospection_element['resultat'] != 'perdu' || $listeprospection_element['resultat'] != 'horscible'): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospection_element['opportunite']['observation']); ?></td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                          <button type="button" class="btn btn-dark attrib_btn" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['opportunite']['id'] .'|'. $listeprospection_element['opportunite']['echeance'] .'|'. \Carbon\Carbon::parse($listeprospection_element['daterelance'])->format('d-m-Y') .'|'.\Carbon\Carbon::parse($listeprospection_element['heure_relance'])->format('H:i:s')); ?>">Reaffecter</button>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent_relance_echeance_admin.blade.php ENDPATH**/ ?>