              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Créer un assureur</h4>
                      ...
                      <div class="row gy-4">
                        ...
                        <div class="col-md-12" style="margin: 0 auto">
                            ...
                            <div class="alert alert-success" role="alert" style="display:none">
                                                    <strong> Assureur enregistré avec succès! </strong>  <b> <a href="">Voir la liste des assureurs</a></b> en savoir
                                                </div>
                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    <label for="basiInput" class="form-label">Libelle de l'assureur</label>
                                    <input type="text" name="libellecanal" class="form-control requiredField" >
                                  </div>
                                </div>
                                <!--end col-->
  ...
  crossorigin="anonymous"></script>
    ...
    $(document).ready(function () {
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/create_assureur.blade.php ENDPATH**/ ?>