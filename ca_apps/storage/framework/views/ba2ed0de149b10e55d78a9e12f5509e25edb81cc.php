   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                        <form id="formtelfield" method="POST" action="/listeprosprectionbytel_agent"  class="col-md-7">
                                            <?php echo csrf_field(); ?>
                                            <div   style=" display: inline-block;width: 170px;">
                                                <div>
                                                    <label for="basiInput" class="form-label">Téléphone</label>
                                                    <input id="telfiltre" type="text" name="telfiltre" class="form-control requiredField" id="basiInput">
                                                </div>
                                            </div>
                                         ...
                                         <form id="formdatefield" method="POST" action="/listeprosprectionbydate"  class="col-md-7" style="display:none">
                                            ...
                                            <div  style=" display: inline-block;width: 170px;">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="datefiltre" type="date" name="datefiltre" class="form-control requiredField" id="exampleInputdate">
                                                    </div>
                                            </div>
                                            <div  style=" display: inline-block;margin-left: 20px;">
                                                <div class="mb-3">
                                        ...
                                        <button style="width:120px;display: none;height: 50px;" id="massaffectation" type="submit"  class="btn btn-success">Affecter en masse </button>
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospection_element['id']); ?></td>
                                                <td>
                                                    <div class="form-check">
                                                ...
                                                <?php if(count($listeprospection_element['commentaires']) >0): ?>)
                                                ...
                                                <td><?php echo e($listeprospection_element['telephone2']); ?></td>
                                                <td>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y')); ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(count($listeprospection_element['affectation'])<=0): ?>
                                                          ...
                                                          <button type="button" class="btn btn-dark attrib_btn" data-bs-toggle="modal"  data-opp="<?php echo e($listeprospection_element['id']); ?>">Affecter</button>
                                                    <?php else: ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent_relance_searchtel.blade.php ENDPATH**/ ?>