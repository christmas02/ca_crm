   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: lavender;margin: 15px;">
                                        ...
                                        <form id="formtelfield" method="POST" action="/filter_opportunite_created_online"  class="col-md-7">
                                            <?php echo csrf_field(); ?>

                                             <div class="col-md-4" style=" display: inline-block;margin-right:15px;">
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($listeprospection_element['agent_enligne']['lastname']??' Non defini'); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/filter_opportunite_created_online.blade.php ENDPATH**/ ?>