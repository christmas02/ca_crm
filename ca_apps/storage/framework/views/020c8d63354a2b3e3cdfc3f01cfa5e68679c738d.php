   ...
   <!--datatable css-->
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="max-width: 100px !important;"><?php echo e($listeprospection_element['opportunite']['telephone']); ?></td>
                                                <td style="max-width: 100px !important;"><?php echo e($listeprospection_element['opportunite']['telephone2']); ?></td>
                                                 <td><?php echo e($listeprospection_element['commentaire']['periode_soucription'] .' mois'); ?></td>
                                                ...
                                                <td>
                                                     ...
                                                     <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="<?php echo e($listeprospection_element['opportunite']['id']); ?>">
                                                                    <li><a class="dropdown-item" href="/enregister_note_propection/<?php echo e($listeprospection_element['opportunite']['id']); ?>">
                                                                        <i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                    Commenter</a></li>
                                                                
                                                                    <li><a class="dropdown-item attrib_btn" href="/prospection_full_details/<?php echo e($listeprospection_element['opportunite']['id']); ?>">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_contrat.blade.php ENDPATH**/ ?>