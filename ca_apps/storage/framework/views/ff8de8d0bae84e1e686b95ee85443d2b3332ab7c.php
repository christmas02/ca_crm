              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Modifier un canal</h4>
                    <div class="flex-shrink-0">
                      <div class="form-check form-switch form-switch-right form-switch-md">
                        <label for="form-grid-showcode" class="form-label text-muted"> <a href="/liste_canaux"> Liste des canaux</a></label>
                      ...
                      <div class="row gy-4">
                         ...
                         <div class="col-md-6" style="margin: 0 auto">
                            ...
                            <div class="alert alert-success" role="alert" style="display:none">
                                                    <strong> Canal enregistré avec succès! </strong>  <b> <a href="">Voir la liste des canaux</a></b> en savoir
                                                </div>
                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-switch form-switch-lg " dir="ltr" style="margin-top:30px;display: inline-block;float: right;">
                                        <input name="isactiv" type="checkbox" class="form-check-input" id="customSwitchsizelg" <?php if($foundcanal[0]['isactive']==1): ?>
                                          
                                         checked=""<?php endif; ?>>
                                        <?php if($foundcanal[0]['isactive']==1): ?>
                                ...
                                <div >
                                  <div>
                                    <label for="basiInput" class="form-label">Libelle du canal</label>
                                    <input type="text" name="libellecanal" class="form-control requiredField" value="<?php echo e($foundcanal[0]['libelle']); ?>" >
                                  </div>
                                </div>
                                <!--end col-->
  ...
  crossorigin="anonymous"></script>
    ...
    $(document).ready(function () {
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/editcanal.blade.php ENDPATH**/ ?>