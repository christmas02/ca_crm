              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Créer un operateur en ligne</h4>
                      ...
                      <div class="row gy-4">
                        ...
                        <div class="col-md-7" style="margin: 0 auto">
                            ...
                            <div class="alert alert-success" role="alert" style="display:none">
                                                    <strong> Opérateur enregistré avec succès! </strong>  <b> <a href="/liste_agent_enligne">Voir la liste des utilisateurs</a></b> 
                                                </div>
                            ...
                            <form id="createuserform" enctype="multipart/form-data" action="" autocomplete="off" method="post">
                                ...
                                <div class=" col-md-6">
                                  <div>
                                    ...
                                    <input type="text" name="login" class="form-control requiredField" >
                                  </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="privilege" id="ForminputState" class="form-select" data-choices data-choices-sorting="true">
                                                            ...
                                                            <option value="niveau1">Full </option>
                                                            <option value="niveau2">Intermediaire </option>
                                                            <option value="niveau3">débutant </option>
                                                        </select>
                                                    </div>
                                                </div>
  ...
  crossorigin="anonymous"></script>
    ...
    $(document).ready(function () {
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/create_operateur_enligne.blade.php ENDPATH**/ ?>