   ...
   <!--datatable css-->
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <?php if(!empty($debutaffect) && !empty($finaffect) ): ?>

                                                 <tr style="background:lightgray;">
                                                <td  colspan="12"><h4 style="text-align:center;"> Affectation - Filtre [<?php echo e($selectedAgent); ?> ]<span style="font-weight:bold"> DEBUT:</span> <span><?php echo e(\Carbon\Carbon::parse($debutaffect)->format('d-m-Y')); ?></span> <span style="font-weight:bold"> FIN: </span> <span><?php echo e(\Carbon\Carbon::parse($finaffect)->format('d-m-Y')); ?></span></h4></td>
                                            </tr>
                                             <?php else: ?>
                                             <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Réaffectations du <?php echo e(date ('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php endif; ?>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(empty($listeprospection_element['commentaire']) && count($listeprospection_element['opportunite']) > 0 ): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\Carbon\Carbon::parse($listeprospection_element['opportunite']['created_at'])->format('d-m-Y H:i')); ?></td>
                                                <td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_reaffectation_datee.blade.php ENDPATH**/ ?>