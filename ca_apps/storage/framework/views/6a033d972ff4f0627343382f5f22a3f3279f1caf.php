   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                  ...
                                  <?php if(isset($finalfiltre)): ?>
                                        
                                  
                                    <p> <?php echo e($finalfiltre .' ' .$datefiltre_deb .' entre et ' .$datefiltre_fin); ?></p>
                                      <?php endif; ?>
                                    <div class="col-md-2">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_byagent_relance.blade.php ENDPATH**/ ?>