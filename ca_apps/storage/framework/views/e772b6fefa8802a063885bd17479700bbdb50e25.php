   ...
   <!--datatable css-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Liste des prospections avec carte grise non verifiées</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Opportunitées avec carte grise non verifiées</h5>
                                </div>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="12"><h3 style="text-align:center;">Opportunitées Carte Grise non vérifiées</h3></td>
                                            </tr>
                                          ...
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if($listeprospection_element['affectation']): ?>
                                                 ...
                                                 <td><?php echo e($listeprospection_element['affectation'][0]['agent_backoffice'][0]['firstname'] .' '.$listeprospection_element['affectation'][0]['agent_backoffice'][0]['lastname']); ?></td>
                                                 <?php else: ?>
                                                 <td><span class="badge badge-pill bg-danger" data-key="t-hot">Non affecté</span></td>
                                                <?php endif; ?>

                                                <td data-sort="<?php echo e($listeprospection_element['created_at']); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospection_element['created_at'])->format('d-m-Y')); ?></td>
                                                ...
                                                <span class="badge badge-pill bg-danger" data-key="t-hot">Non Flagué</span>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_cg_non_verif.blade.php ENDPATH**/ ?>