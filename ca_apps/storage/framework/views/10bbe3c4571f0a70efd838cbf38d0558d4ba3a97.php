   ...
   <!--datatable css-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0"> Opportunites remontées</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Opportunitées remontées  par  <?php echo e($listeprospection[0]['agent_terrain']['lastname']??' Non defini'); ?></h5>
                                </div>
                                ...
                                <div id="filterform" class="row gy-4" style="padding-left: 20px;background: #f2f2f2;margin: 15px;">
                                    ...
                                    <div class="col-md-10">
                                        <form id="formtelfield" method="POST" action="/listeprosprectionbytel"  class="col-md-7">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:lightgray;">
                                                <td  colspan="11"><h3 style="text-align:center;">Opportunitées remontées par <?php echo e($listeprospection[0]['agent_terrain']['lastname']??' Non defini'); ?> </h3></td>
                                            </tr>
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tel1"><?php echo e($listeprospection_element['telephone']); ?></td>
                                                <td>
        ...
        var arr = [];
            $(".tel1").each(function(){
                ...
                if (arr.indexOf(value) == -1)
                    ...
                    $(this).parents('tr').addClass("duplicate");
            });
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/detail_remontee_agent_terrain.blade.php ENDPATH**/ ?>