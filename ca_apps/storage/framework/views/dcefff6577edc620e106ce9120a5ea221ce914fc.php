   ...
   <!--datatable css-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            <?php if($datedebut !== null  && $datefin !== null && $periodecontrat !== null): ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN [<?php echo e($periodecontrat .' Mois'); ?>] condensés du  <?php echo e(\Carbon\Carbon::parse($datedebut)->format('d-m-Y') .' au '.\Carbon\Carbon::parse($datefin)->format('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:lightgray;">
                                                <td  colspan="13"><h3 style="text-align:center;">Contrats AN/RN condensés du <?php echo e(date ('d-m-Y')); ?></h3></td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                                 <th>Nom</th>
                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $contrat_condens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contrat_condens_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($contrat_condens_element['totaltraites']); ?></td>
                                                <td><?php echo e($contrat_condens_element['nbre_opport_gagne']); ?></td>
                                                ...
                                                <?php if(count($contrat_condens_element['agent_backoffice']['affectations']) !=0): ?>
                                                <td><?php echo e(number_format( $contrat_condens_element['totaltraites'] * 100 / count( $contrat_condens_element['agent_backoffice']['affectations']) ,2)
                                                 . ' % '); ?> </td>
                                                 <?php else: ?>
                                                     <td><?php echo e(0 .' %'); ?></td>
                                                 <?php endif; ?>

                                                 <td><?php echo e(number_format($contrat_condens_element['nbre_opport_gagne'] * 100 / $contrat_condens_element['totaltraites'] ,2) 
                                                 . ' % '); ?>  </td>


                                                  

                                                <td><?php echo e($contrat_condens_element['sumprimenet']); ?></td>
                                                <td><?php echo e($contrat_condens_element['sumprimettc']); ?></td>

                                             <?php if($datedebut !== null  && $datefin !== null): ?>
                                                <td>
                                                    <?php if($contrat_condens_element['nbre_opport_gagne'] !=0): ?>
                                                        
                                                    
                                                    <a class="btn btn-dark" href="/details_contrats_byagent/<?php echo e($contrat_condens_element['agent_backoffice']['id'].'/'.$datedebut.'/'.$datefin); ?>">Details</a>
                                                    <?php else: ?>
                                                     - 
                                            ...
                                            <td>
                                                <?php if($contrat_condens_element['nbre_opport_gagne'] !=0): ?>
                                                    <a class="btn btn-dark" href="/details_contrats_byagent/<?php echo e($contrat_condens_element['agent_backoffice']['id'].'/'.$today.'/'.$today); ?>">Details</a>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/bordereaux_contrat_condense.blade.php ENDPATH**/ ?>