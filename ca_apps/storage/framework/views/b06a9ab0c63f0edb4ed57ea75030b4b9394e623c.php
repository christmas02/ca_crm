   ...
   <!--datatable css-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Liste des prospections supprimées</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header" style="margin-bottom: 15px;">
                                    <h5 class="card-title mb-0">Opportunitées supprimées</h5>
                                </div>
                                        ...
                                        <form id="formnamefield" method="POST" action="/listeprosprectionbyname"  class="col-md-7">
                                            ...
                                            <div  style=" display: inline-block;margin-left: 20px;">
                                                <div class="mb-3">
                                                    ...
                                                    <button style="width:120px" type="submit"  class="btn btn-danger">FILTRER</button>
                                                </div>
                                            </div>
                                    ...
                                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                        <thead>
                                            ...
                                            <tr style="background:#ff0000;">
                                                <td  colspan="13"><h3 style="text-align:center;color: white;">Opportunitées Supprimées</h3></td>
                                            </tr>
                                            <?php else: ?>
                                            <tr style="background:#ff0000;">
                                                <td  colspan="11"><h3 style="text-align:center;color: white;">Opportunitées Supprimées</h3></td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $listeprospection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listeprospection_element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td data-sort="<?php echo e(\Carbon\Carbon::parse($listeprospection_element['echeance'])->format('d-m-Y')); ?>"><?php echo e(\Carbon\Carbon::parse($listeprospection_element['echeance'])->format('d-m-Y')); ?></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_prospection_suppr.blade.php ENDPATH**/ ?>