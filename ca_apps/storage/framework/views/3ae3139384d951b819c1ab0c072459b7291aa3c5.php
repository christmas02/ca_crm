   ...
   <!--datatable css-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Renouvellement</h5>
                                </div>
                                         ...
                                         <form id="formdatefield" method="POST" action="/listeprosprectionbydate"  class="col-md-7" style="display:none">
                                            ...
                                            <div  style=" display: inline-block;width: 270px;">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="datefiltre" type="date" name="datefiltre" class="form-control requiredField" id="exampleInputdate" required>
                                                    </div>
                                            </div>
                                            <div  style=" display: inline-block;margin-left: 20px;">
                                                <div class="mb-3">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zekotch/development/laravel_projets/backofficeassurance/resources/views/liste_renouvellement.blade.php ENDPATH**/ ?>